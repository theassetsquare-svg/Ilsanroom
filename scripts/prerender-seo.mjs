...
const staticPages = [
  ...
  { path: '/clubs', title: '새벽 2시에도 줄이 안 줄어드는 클럽만 골랐다', desc: '강남 홍대 이태원 일산 부산 EDM·힙합·테크노 클럽 35곳 비교. 입장료 1~3만원, 분위기, 드레스코드, 영업시간 한눈에. 첫방문 코스, 게스트 라인업, 부킹 문화, 줄 안 서는 시간대까지 정리. 오늘 밤 갈 곳 여기서 픽.' },
  { path: '/nights', title: '라이브 밴드가 울리면, 모르는 사람도 파트너가 된다', desc: '소셜댄스 나이트 58곳 총집합. 강남 부산 수원 일산 부킹 문화부터 드레스코드 입장료 시간대별 분위기까지. 부스·룸 구성, 양주 시세, 첫방문 매너 가이드. 첫 발 딛기 전에 읽어라.' },
  { path: '/lounges', title: '조용히 한 잔, 대화만 남는 밤을 원한다면', desc: '강남 홍대 이태원 일산 라운지바 비교 가이드. 칵테일·위스키·와인 시세 분위기 드레스코드 접대 데이트 혼술 추천까지. 야경 좋은 루프탑 호텔 라운지 베스트 정리. 1인 3~15만원 예산별 코스.' },
  { path: '/rooms', title: '바깥 소리 하나 안 들리는 방, 그게 룸이다', desc: '4인 소형부터 30인 단체석까지 룸 전체 카테고리. 인원별 사이즈, 발렌타인 조니워커 양주 라인업, 예약 팁, 시세 비교. 일산 강남 수원 부산 룸 정보 한눈에. 1인 7~20만원 객단가 가이드.' },
  { path: '/yojeong', title: '대금 소리에 정찬 15첩, 한 번 오면 단골 된다', desc: '전통 요정 정찬 국악 라이브 프라이빗 룸. 비즈니스 만찬 외국 손님 접대 검증. 코스 가격대 15~25만원, 예약 방법, 드레스코드, 매너까지 입문자 가이드 정리. 일산명월관 등 추천.' },
  { path: '/hoppa', title: '처음인데 혼자 가도 괜찮을까? 결론부터, 된다', desc: '여성 전용 사교 공간 호빠 18곳 실전 가이드. 강남 종로 영등포 해운대 대구 시세, 분위기, 안전 정보, 매너 매뉴얼 정리. 초이스 방법, 객단가 5~15만원, 첫방문 동선, 마담 인증, 카드 결제 가능 업소까지. 여자 혼자도 안전하게.' },

  // Interactive pages
  { path: '/guide', title: '처음이라 긴장된다고? 이거 읽고 가면 프로다', desc: '클럽·나이트·라운지·룸·요정·호빠 6개 업종별 입문 가이드. 강남 홍대 이태원 일산 부산 드레스코드, 1인 예산 3~25만원, 혼자 가도 안전한 곳, 첫방문 매너, 부킹·초이스 흐름까지 5분 정독 완성.' },
  { path: '/map', title: '지금 위치에서 가까운 곳, 지도에 다 떴다', desc: '강남 홍대 이태원 일산 부산 수원 핫스팟 인터랙티브 지도. 핀 한 번 클릭으로 전화 연결, 카카오맵 길찾기, 평점, 객단가, 영업시간 즉시 확인. 영업 중인 업소만 실시간 자동 표시.' },
  ...
  { path: '/venue-info', title: '양주·부스·룸 한눈에 보기', desc: '업종별 양주 라인업(발렌타인 12·17·21년산, 조니워커 블루, 로얄살루트), 부스 4~12인 사이즈, 룸 4~30인 타입까지 정리. 강남 홍대 일산 부산 인기 업소 객단가 가이드. 가기 전에 미리 확인하고 예약하세요.' },
  { path: '/compare', title: '두 곳 놓고 따져보면 후회가 없다', desc: '가격·분위기·후기·평점·접근성 5개 항목별 두 업소 1대1 비교표. 강남 vs 홍대, 클럽 vs 라운지 등 인기 매치업 모음. 객단가 시세 차이, 매니저 평판, 음악 장르, 드레스코드까지 한눈에. 고민 끝 선택만.' },
  ...
  { path: '/community/reviews', title: '가본 사람만 쓸 수 있다, 실제 방문 후기', desc: '별점·한 줄 평으로 보는 업소 리얼 리뷰. 광고 아닌 진짜 목소리만 모은 후기 광장. 강남 홍대 이태원 일산 부산 클럽·나이트·라운지·룸·요정·호빠 전 업종 객단가·서비스·매너 솔직 평가 정리.' },
  { path: '/community/tips', title: '고수들이 풀어놓은 밤놀이 실전 꿀팁', desc: '입장 타이밍, 자리 잡는 법, 안 당하는 법, 시세 협상 노하우, 단골 만드는 매너까지. 경험자만 아는 실전 가이드. 강남 홍대 이태원 일산 수원 부산 지역별 꿀팁과 안전 팁 총정리.' },
  ...
  { path: '/community/guidelines', title: '이것만 지키면 된다, 커뮤니티 규칙', desc: '놀쿨 커뮤니티 운영 규칙 전문. 광고·욕설·개인정보 노출·도배·성매매 암시·2차 알선·불법 거래는 즉시 차단. 익명 보장하되 기본 매너만 지키면 자유롭게. 신고·블락 시스템과 운영진 24시간 모니터링으로 깨끗한 광장 유지.' },
  ...
  { path: '/lounge/night', title: '나이트 라운지 — 나이트 경험담 공유', desc: '강남 부산 수원 일산 광주 평택 나이트 다녀온 사람들의 실시간 이야기. 부킹 성공기, 부스 시세 30~80만원, 매니저 평판, 양주 라인업 비교까지. 솔직 후기와 질문이 오가는 나이트 전용 게시판.' },
  { path: '/lounge/club', title: '클럽 라운지 — 클럽 이야기', desc: '강남 홍대 이태원 일산 클럽 음악·DJ·분위기·게스트 라인업 추천 정보. EDM 힙합 테크노 장르별 추천, 입장 줄 짧은 시간대, 친구와 가는 코스 등 클럽 다니는 사람들의 전용 게시판.' },
  { path: '/lounge/room', title: '룸 라운지 — 룸 이야기', desc: '일산 강남 수원 부산 해운대 룸 이용 후기와 추천 정보. 4인 소형부터 30인 단체석까지 인원별 시세, 발렌타인 12·17년 조니워커 블루 로얄살루트 양주 라인업, 매니저 평판, 예약 팁, 단골 인사이더 공유.' },
  { path: '/lounge/yojung', title: '요정 라운지 — 요정 이야기', desc: '전통 요정 방문 경험과 정보 공유. 정찬 15첩 코스, 국악 라이브, 비즈니스 만찬 후기. 일산명월관·종로요정·강남요정 등 가격대 15~25만원 코스, 드레스코드, 예약 매너까지.' },
  { path: '/lounge/hoppa', title: '호빠 라운지 — 호빠 이야기', desc: '여성 전용 사교 공간 호빠 방문 후기·추천. 강남 종로 영등포 해운대 대구 시세, 마담 인증, 매니저 평판, 첫방문 동선, 안전 정보, 카드 결제 가능 업소까지. 여자 혼자 가도 안전한 호빠 정보 전용 게시판.' },
  { path: '/lounge/lounge', title: '라운지바 라운지 — 라운지바 이야기', desc: '강남 홍대 이태원 일산 부산 라운지바 분위기·칵테일·위스키 추천 게시판. 데이트 코스, 접대용 프라이빗 라운지, 야경 좋은 루프탑·호텔 라운지 후기. 1인 3~15만원 예산별 추천과 객단가 비교 공유.' },
  ...
  { path: '/lounge/qna', title: '라운지 질문답변 — 뭐든 물어보세요', desc: '밤문화 관련 궁금한 거 다 답해주는 Q&A 게시판. 첫방문 매너, 강남 홍대 이태원 일산 부산 가격대 비교, 업소 추천, 안전 팁, 드레스코드까지. 단골 회원들이 빠르게 답변해주는 실시간 질문방.' },
  ...
  { path: '/venue-terms', title: '업소 등록 및 광고 게재 약관', desc: '업소 게재 조건·환불 정책·삭제 기준 명시. 신청 절차, 콘텐츠 검수 기준, 부적절 광고 처리, 무료 체험 14일, 결제·환불·해지, 분쟁 시 중재 절차까지. 사장님 등록 전 반드시 읽으세요.' },
  ...
  { path: '/help', title: '자주 묻는 질문, 여기 다 답해놨다', desc: '나이 제한, 복장 규정, 입장료, 예약 방법, 환불 정책, 회원 등급, 포인트 사용, 카카오·네이버 로그인 문제까지 자주 묻는 질문 한 번에 해결. 검색 한 번이면 답이 나오는 놀쿨 통합 FAQ 페이지.' },

  // Business
  { path: '/for-business', title: '사장님, 가게 올리면 월 1,200명이 봅니다', desc: '14일 무료 체험으로 시작. 등록만 하면 구글·네이버 검색 노출, 전화 연결, 리뷰 관리, 통계 대시보드 전부 가능. 강남·홍대·일산 등 핵심 지역 사장님 200명 입점. 카톡 besta12 문의.' },
  ...
  { path: '/pricing', title: '요금제 4단계, 0원부터 시작 가능', desc: '무료 체험 14일 후 결정해도 늦지 않습니다. 베이직·프로·프리미엄·VIP 4단계 요금제 비교, 지역과 업소 특성에 맞춘 입점 제안, 광고 노출 영역과 분석 리포트 차이 정리. 해지도 클릭 한 번. 카카오톡 besta12로 상세 문의.' },
  ...
  // Lead magnets
  { path: '/lead/nightlife-guide', title: '서울경기 나이트라이프 완벽 가이드 — 현지인만 아는 진짜 핫플', desc: '서울·경기 나이트라이프 현지인 추천 가이드. 강남 홍대 이태원 일산 수원 분당 클럽·라운지·바·룸·나이트 드레스코드, 1인 객단가 3~25만원, 입장 골든타임, 부킹 흐름, 인사이더 팁까지 총정리.' },
  ...
  { path: '/billing', title: '구독·결제 내역 한눈에', desc: '현재 요금제·결제 이력·플랜 변경·해지를 한 페이지에서 처리. 무료/스타트/프로/VIP 4단계 요금제, 14일 무료 체험 후 자동 결제, 카드·계좌이체·간편결제 모두 지원하는 통합 빌링 센터.' },
  { path: '/onboarding', title: '3분이면 끝나는 입점 신청', desc: '사업자등록증과 매장 사진 3장이면 입점 완료. 24시간 내 심사·노출 시작, 14일 무료 체험 후 요금제 선택, 전담 매니저 1:1 가이드까지 제공. 복잡한 서류 작성 없이 누구나 쉽게 입점 가능.' },
...
const CAT_GUIDE_BLURBS = {
  club: `<h2>클럽 처음 가는 사람을 위한 5분 가이드</h2><p>클럽은 EDM·힙합·테크노 등 장르별로 분위기가 완전히 다릅니다. 강남은 트렌디한 EDM 라운지가 많고, 홍대는 인디·언더그라운드가, 이태원은 힙합·라틴이 강세입니다. 입장 시간은 보통 23시~01시가 피크이고, 새벽 2시 이후가 가장 뜨겁습니다.</p><h2>클럽 드레스코드 — 운동화 ok 가능한 곳 vs 막는 곳</h2><p>대형 클럽은 운동화·반바지 입장 거부가 많고, 중소형은 캐주얼 ok입니다. 여성은 원피스·스커트 무난, 남성은 셔츠·치노바지 안전합니다. 모자·삼선 슬리퍼·찢어진 청바지는 대부분 거절됩니다.</p><h2>입장료·테이블·N빵 시세</h2><p>강남 메인 클럽 기본 입장료 2~3만원, 홍대 1~2만원, 이태원 1.5~2.5만원 선입니다. 테이블은 4인 30~80만원, 부스 100~300만원이 일반적이며 N빵하면 1인 7~20만원입니다. 가격은 업소·요일·시즌에 따라 변동됩니다.</p>`,
  night: `<h2>나이트 처음인데 부킹 어떻게 하나요?</h2><p>나이트는 웨이터가 부킹을 잡아주는 시스템입니다. 입장 후 자리에 앉으면 담당 웨이터가 인사하고, 원하는 스타일(직장인·연상·연하 등)을 말하면 매칭해줍니다. 마음에 안 들면 거절 자유, 추가 매칭 가능합니다.</p><h2>나이트 양주·안주 시세</h2><p>기본 양주 1병 20~40만원, 부킹 자리 양주 30~60만원, 룸 양주 50~150만원 선입니다. 안주는 과일·드라이 1~3만원이 보통입니다. 첫 방문 시 웨이터 추천 받는 것이 안전합니다.</p><h2>나이트 영업시간·피크타임</h2><p>대부분 21시 오픈, 03~05시 마감입니다. 부킹 활성 시간은 23~02시이고, 평일은 한산, 금토일은 만석입니다. 사전 예약하면 좋은 자리·좋은 부킹을 받을 수 있습니다.</p>`,
  lounge: `<h2>라운지바와 클럽의 차이</h2><p>라운지바는 음악이 작고 좌석 위주이며, 대화·데이트·접대 목적이 많습니다. 클럽처럼 댄스플로어 중심이 아니라 칵테일·위스키·와인을 천천히 즐기는 공간입니다. 드레스코드는 스마트 캐주얼이 무난합니다.</p><h2>라운지 추천 상황별 가이드</h2><p><strong>데이트:</strong> 야경 좋은 루프탑·창가 자리. 칵테일 1.5~3만원, 와인 한 병 8~20만원.<br/><strong>비즈니스 미팅:</strong> 프라이빗 룸이 있는 호텔 라운지. 사전 예약 필수.<br/><strong>혼술:</strong> 바 자리가 잘 갖춰진 위스키 라운지. 1~2시간 머물기 좋음.</p><h2>라운지 시세 — 1인당 예산</h2><p>가벼운 칵테일 2잔: 3~6만원. 위스키 1잔 + 안주: 5~10만원. 와인 한 병 + 치즈 플래터: 1인 7~15만원. 대부분 자릿세 없고 주문 금액이 곧 객단가입니다.</p>`,
  room: `<h2>룸 — 인원수별 추천 사이즈</h2><p>4~6인은 소형 룸, 8~12인은 중형, 15~30인은 대형 룸이 적합합니다. 무대·노래방기기 유무, 양주 라인업, 이모님 응대 방식이 업소마다 다릅니다. 미리 통화로 인원·시간·예산을 말하면 맞춤 세팅됩니다.</p><h2>룸 양주·세트 구성</h2><p>기본 양주 1병 + 안주: 20~40만원. 발렌타인 12·17·21년산, 조니워커 블루, 로얄살루트 등이 메인 라인업입니다. 4인 기준 양주 1병 + 맥주 + 안주 = 50~80만원이 평균 객단가입니다.</p><h2>룸 예약 팁 — 평일 vs 주말</h2><p>평일은 당일 예약 가능, 금·토는 최소 2~3일 전 예약 권장입니다. 단체석은 1주일 전, 연말·송년회 시즌은 2주 전이 안전합니다. 첫 방문 시 단골 손님 소개 받으면 응대가 더 좋습니다.</p>`,
  yojeong: `<h2>요정이란 — 한정식 + 국악 + 프라이빗 룸</h2><p>요정은 일반 음식점이 아니라 전통 한정식과 국악 라이브, 프라이빗 룸이 결합된 격식 있는 공간입니다. 비즈니스 만찬, 외국 손님 접대, 가족 모임에 자주 사용됩니다. 일반 룸살롱과 다르게 음식이 메인입니다.</p><h2>요정 코스 구성과 가격대</h2><p>기본 한정식 코스(15~20첩): 1인 8~15만원. 프리미엄 코스(전복·송이 추가): 1인 15~25만원. 국악 라이브 추가 시 인당 3~5만원. 프라이빗 룸 사용료 별도 5~20만원입니다.</p><h2>요정 예약 — 사전 확인 필수</h2><p>요정은 대부분 예약제로 운영되며 당일 방문이 어렵습니다. 최소 2~3일 전 전화 예약, 인원·코스·국악 유무·룸 사이즈를 미리 정해야 합니다. 외국 손님이 동반될 경우 영어 가능 여부도 사전 확인 필수입니다.</p>`,
  hoppa: `<h2>호빠 처음인데 어떻게 가나요?</h2><p>호빠는 여성 전용 사교 공간으로, 남성 호스트와 대화·술·노래를 즐기는 곳입니다. 입장 시 마담(매니저)이 안내하고 호스트 프로필을 보여줍니다. 마음에 드는 호스트를 지목하거나 추천 받을 수 있습니다.</p><h2>호빠 시세 — 솔직한 가격대</h2><p>기본 세트(양주 1병 + 안주 + 호스트 1명): 30~60만원. 추가 호스트 지목 시 인당 10~20만원. 노래방·게임 비용 별도. 단골이 되면 마담 할인·서비스 안주가 들어옵니다. N빵 시 1인 15~30만원이 일반적입니다.</p><h2>호빠 안전 팁 — 처음 가는 여성 필독</h2><p>1) 첫 방문은 친구와 함께. 2) 신뢰 가는 마담 있는 곳을 추천 받기. 3) 영업시간·시세를 사전 확인. 4) 카드 결제 가능 업소가 안전. 5) 술 강요·과도한 매출 압박이 있으면 즉시 자리 이동. 6) 귀가는 콜택시·대리운전 활용.</p>`,
};
...
writePage('/', {
  ...
  description: `강남 홍대 이태원 일산 부산 수원 전국 클럽·나이트·라운지·룸·요정·호빠 ${venues.length}곳 실시간 비교. 솔직 후기, 시세 비교, 부킹 문화, 드레스코드, 조각모임, 벙개까지. 한 곳에서 다 본다.`,
...
const COMMUNITY_BOARD_BLURBS = {
  ...
  '/community/qna': () => `<h1>오늘 밤 어디 가냐고? 여기서 추천받아</h1><p>갈 곳 못 정한 사람들이 모여 서로 추천해주는 게시판. 인원, 분위기, 예산만 적으면 단골들이 답해줍니다.</p><h2>자주 묻는 질문 TOP 5</h2><ul><li>강남 클럽 줄 안 서는 시간은?</li><li>홍대 4명 갈 만한 라운지 추천</li><li>여자친구 생일, 룸 처음인데 어디?</li><li>30대 남자 혼자 가기 좋은 곳</li><li>커플이 가기 좋은 분위기 좋은 곳</li></ul><h2>지역별 인기 질문</h2><ul><li>강남역 근처 — 부킹 잘되는 나이트 어디?</li><li>홍대 — 평일 사람 많은 클럽?</li><li>이태원 — 외국인 많은 라운지?</li><li>일산 — 룸 양주 합리적인 곳?</li><li>수원 — 단체 30명 가능한 룸?</li></ul><h2>답변 잘 받는 글쓰기 팁</h2><p>인원, 예산, 분위기, 지역 4가지를 명확히 적으면 단골들이 빠르게 답해줍니다. 막연한 질문보다 "강남역 4명 평일 저녁 1인 5만원 예산"처럼 구체적으로 쓰면 정확한 추천이 옵니다. 답변에 추천된 곳을 다녀온 후 후기도 남겨주세요.</p>`,
  '/community/reviews': () => `<h1>가본 사람만 쓸 수 있다, 실제 방문 후기</h1><p>별점과 한 줄 평으로 보는 업소 리얼 리뷰. 광고 아닌 진짜 목소리.</p><h2>업종별 후기 카테고리</h2><ul><li>클럽 후기 — 음악, 부킹, 입장</li><li>나이트 후기 — 밴드, 부스, 룸</li><li>라운지 후기 — 분위기, 안주, 가격</li><li>룸 후기 — 시설, 양주 구성, 매니저</li><li>요정 후기 — 정찬, 공연, 분위기</li><li>호빠 후기 — 매너, 분위기, 가격</li></ul><h2>인기 후기 주제</h2><ul><li>강남 클럽 신작 후기</li><li>홍대 라운지 데이트 후기</li><li>일산 룸 단체석 후기</li><li>부산 해운대 호빠 첫방문 후기</li><li>요정 비즈니스 접대 후기</li></ul><h2>좋은 후기 작성 가이드</h2><p>다녀온 날짜, 인원, 객단가를 명시하면 다른 회원에게 큰 도움이 됩니다. 음악·서비스·가격·분위기 4가지를 별점으로 평가하고 한 줄 코멘트를 남겨주세요. 사진은 매장 외관·룸 내부·메뉴판 정도가 적당하며, 손님 얼굴이 보이는 사진은 피해주세요.</p>`,
  '/community/tips': () => `<h1>고수들이 풀어놓은 밤놀이 실전 꿀팁</h1><p>입장 타이밍, 자리 잡는 법, 안 당하는 법. 경험자만 아는 노하우.</p><h2>분야별 꿀팁</h2><ul><li>클럽 입장 줄 줄이는 법</li><li>나이트 부스 잘 잡는 시간</li><li>룸 양주 구성 합리적으로 짜는 법</li><li>요정 코스 처음 받는 가이드</li><li>호빠 매너와 흐름</li><li>대리, 택시 잡는 시간대 노하우</li></ul><h2>안 당하는 팁 — 안전 가이드</h2><ul><li>현금보다 카드 결제 가능한 곳</li><li>처음 가는 곳은 첫 잔만 받기</li><li>매니저 명함 받아두기</li><li>일행 위치 공유 켜두기</li><li>술 강요 시 즉시 자리 이동</li></ul><h2>시간대별 베스트 픽</h2><p>20~22시는 라운지·바, 22~00시는 클럽·나이트 입장 골든타임, 00~02시가 부킹·메인타임, 02시 이후는 룸·해장 코스가 정석입니다. 평일은 한산하고 단가가 낮고, 금토는 만석에 단가도 높습니다. 첫 방문은 평일 저녁이 안전합니다.</p>`,
  '/community/party': () => `<h1>같이 갈 사람 손! 파티 멤버 모집</h1><p>날짜 맞추고, 인원 채우고, N빵. 혼자 가기 아까울 때 여기서 구해.</p><h2>모집 카테고리</h2><ul><li>오늘 밤 즉시 모집</li><li>주말 미리 매칭</li><li>특정 업소 함께 갈 사람</li><li>커플/짝남짝녀 모임</li><li>30대 모임</li><li>출장 와서 동행</li></ul><h2>인기 모집 형태</h2><ul><li>강남 클럽 4인 N빵 (1인 7~10만원)</li><li>홍대 라운지 데이트 짝매칭</li><li>일산 룸 단체 12명 (1인 5만원)</li><li>부산 해운대 출장자 동행</li><li>주말 1박2일 클럽투어</li></ul><h2>안전한 모집 가이드</h2><p>사람 모을 때 인원, 일시, 장소, 1인당 예산, 연령대를 명확히 적어주세요. 만남 전 단톡방을 먼저 만들고, 입금은 모임 당일 만나서 합니다. 노쇼 방지를 위해 100P 이상 회원만 작성 가능하며, 노쇼 시 평점이 깎입니다.</p>`,
...
const INTERACTIVE_PAGE_BLURBS = {
  ...
  '/guide': () => `<h1>처음이라 긴장된다고? 이거 읽고 가면 프로다</h1><p>드레스코드, 예산, 혼자 가도 되는지까지. 업종별 입문 핵심만 정리했습니다. 5분이면 다 읽을 수 있습니다.</p><h2>업종별 입문 가이드</h2><ul><li>클럽 — 입장 시간, 드레스코드, 부킹</li><li>나이트 — 부스 잡는 법, 양주 시세</li><li>라운지 — 칵테일 추천, 데이트 코스</li><li>룸 — 인원별 사이즈, 양주 구성</li><li>요정 — 한정식 코스, 예약 필수</li><li>호빠 — 첫 방문, 안전 매너</li></ul><h2>예산별 추천 코스</h2><ul><li>1인 3만원 — 라운지바 칵테일 2잔</li><li>1인 7만원 — 클럽 입장 + 양주 한 잔</li><li>1인 15만원 — 룸 4인 N빵 양주 1병</li><li>1인 25만원 — 호빠 기본 세트</li><li>1인 40만원 — 요정 정찬 + 룸</li></ul><h2>처음 가는 사람을 위한 5계명</h2><p>1) 평일 저녁이 가장 안전합니다. 2) 첫 잔은 천천히 마시고 분위기 파악하세요. 3) 신용카드 결제 가능한 곳이 안전합니다. 4) 일행과 연락 자주 하고 위치 공유 켜두세요. 5) 술 강요·과도한 매출 압박이 있으면 즉시 자리 이동하세요.</p>`,
  '/map': () => `<h1>지금 위치에서 가까운 곳, 지도에 다 떴다</h1><p>핀 하나 누르면 전화·길찾기 바로 연결. 내 주변 영업 중인 업소만 표시됩니다.</p><h2>지도에서 확인 가능한 정보</h2><ul><li>업소명·주소·전화번호</li><li>현재 영업 중 여부</li><li>대표 사진과 평점</li><li>인기 메뉴와 시세</li><li>주차 가능 여부</li><li>대리 호출 연동</li></ul><h2>지역별 핫스팟</h2><ul><li>강남역 반경 500m — 클럽 8곳</li><li>홍대 4번 출구 — 라운지 5곳</li><li>이태원역 — 외국인 친화 5곳</li><li>일산 라페스타 — 룸 6곳</li><li>부산 해운대 — 호빠 4곳</li></ul><h2>지도 사용 팁</h2><p>줌인 하면 골목 단위로 표시되고, 클러스터 클릭하면 해당 영역 업소 리스트가 펼쳐집니다. 영업시간 외 업소는 회색으로 표시되며, 신규 등록 업소는 핑크 핀으로 강조됩니다.</p>`,
  '/search': () => `<h1>이름만 치면 바로 나온다, 통합 검색</h1><p>지역·업종·이름 아무거나 입력하면 120곳 중에서 딱 맞는 곳을 찾아드립니다.</p><h2>검색 가능 항목</h2><ul><li>업소명 — "레이스" "찬스돔" 등</li><li>지역명 — "강남" "홍대" "일산"</li><li>업종 — "클럽" "룸" "호빠"</li><li>분위기 — "조용한" "단체" "데이트"</li><li>예산 — "5만원" "10만원"</li></ul><h2>검색 잘 하는 팁</h2><ul><li>지역+업종 조합이 정확도 높음</li><li>오타 자동 보정 지원</li><li>인기 검색어 자동완성</li><li>최근 검색 기록 저장</li><li>필터로 추가 좁히기</li></ul><h2>이번 주 인기 검색어</h2><p>강남클럽, 홍대라운지, 일산룸, 부산호빠, 이태원클럽, 수원나이트, 강남룸, 데이트코스, 단체회식, 출장동행이 가장 많이 검색되고 있습니다. 지역+업종+인원 키워드 조합이 검색 만족도가 가장 높습니다.</p>`,
  ...
  '/dashboard': () => `<h1>내 매장 현황판, 실시간 확인</h1><p>오늘 방문자, 전화 클릭, 인기 시간대를 한눈에 보는 사장님 전용 데이터입니다.</p><h2>대시보드 주요 지표</h2><ul><li>오늘 페이지뷰</li><li>전화번호 클릭 수</li><li>찜하기 추가 수</li><li>후기 작성 수</li><li>유입 지역 분포</li></ul><h2>매장 운영 인사이트</h2><ul><li>요일별 방문자 추이</li><li>시간대별 클릭 분포</li><li>경쟁 업소 비교</li><li>리뷰 평점 추이</li><li>월간 객단가 추정</li></ul><h2>대시보드 활용 팁</h2><p>주간 트래픽이 떨어지면 사진·메뉴 업데이트로 노출을 끌어올리세요. 부정 후기 발생 시 24시간 내 답변하면 평점 회복 가능합니다. 데이터는 5분마다 갱신되며 모바일에서도 동일하게 확인할 수 있습니다.</p>`,
  '/billing': () => `<h1>구독·결제 내역 한눈에</h1><p>현재 요금제, 결제 이력, 변경·해지 모두 이 페이지에서 처리할 수 있습니다.</p><h2>요금제 종류</h2><ul><li>무료 — 기본 등록 (사진 3장, 메뉴 5개)</li><li>스타트 (월 9만원) — 사진 무제한, 노출 우선순위</li><li>프로 (월 19만원) — 메인 노출, 분석 리포트</li><li>VIP (월 39만원) — 단독 영역, 푸시 알림</li></ul><h2>결제 방법</h2><ul><li>카드 자동 결제</li><li>계좌이체 (수동)</li><li>법인카드 + 세금계산서 발행</li><li>14일 무료 체험 후 자동 결제</li></ul><h2>해지·환불 정책</h2><p>언제든 클릭 한 번으로 해지 가능하며, 미사용 일자만큼 일할 환불됩니다. 14일 무료 체험 기간 내 해지 시 결제되지 않습니다. 세금계산서는 매월 1일 자동 발행되며 이메일로 전송됩니다.</p>`,
  '/onboarding': () => `<h1>3분이면 끝나는 입점 신청</h1><p>상호명, 사진, 연락처만 넣으면 등록 완료. 복잡한 거 없습니다.</p><h2>입점 신청 절차</h2><ul><li>1단계 — 사업자등록증 업로드</li><li>2단계 — 매장 사진 3장 이상</li><li>3단계 — 영업시간·연락처 입력</li><li>4단계 — 메뉴·시세 등록</li><li>5단계 — 노출 영역 선택</li></ul><h2>입점 후 1주일 내 할 일</h2><ul><li>리뷰 응대 알림 설정</li><li>대시보드 모바일 앱 설치</li><li>요금제 선택 (14일 무료)</li><li>경쟁 업소 분석 리포트 확인</li><li>광고 캠페인 계획 수립</li></ul><h2>입점 후 평균 효과</h2><p>등록 1주일 내 평균 800회 노출, 첫 달 평균 120건 전화 클릭, 평균 25건 신규 방문 발생합니다. 사진 품질이 좋을수록 효과가 비례합니다. 입점 컨설팅이 필요하면 케이스 스터디 페이지에서 사례를 참고하세요.</p>`,
  ...
  '/help': () => `<h1>자주 묻는 질문, 여기 다 답해놨다</h1><p>나이 제한, 복장 규정, 입장료 궁금증. 검색 한 번에 해결됩니다.</p><h2>일반 이용 FAQ</h2><ul><li>나이 제한이 있나요? — 만 19세 이상</li><li>혼자 가도 되나요? — 업종에 따라 다름</li><li>예약은 필수인가요? — 룸·요정은 필수</li><li>드레스코드는? — 업종별 가이드 참고</li><li>주차 가능한가요? — 업소 페이지 확인</li></ul><h2>회원·포인트 FAQ</h2><ul><li>가입 비용 있나요? — 100% 무료</li><li>탈퇴는 어떻게? — 프로필에서 1클릭</li><li>포인트 사용처는? — 등급 승급, 향후 쿠폰</li><li>닉네임 변경 가능한가요? — 월 1회</li><li>비밀번호 분실 시? — 카카오 재로그인</li></ul><h2>업주 FAQ</h2><p>입점 신청은 onboarding 페이지에서 가능하며, 사업자등록증과 매장 사진 3장 이상이 필요합니다. 14일 무료 체험 후 요금제를 선택할 수 있고, 언제든 해지 가능합니다. 광고 효과는 평균 첫 달 120건 전화 클릭, 25건 신규 방문이 발생합니다.</p>`,
  '/compare': () => `<h1>두 곳 놓고 따져보면 후회가 없다</h1><p>가격·분위기·후기 항목별 비교표. 고민 끝, 선택만 남았습니다.</p><h2>비교 가능한 항목</h2><ul><li>입장료·시세 비교</li><li>평균 객단가</li><li>후기 평점·개수</li><li>분위기 키워드</li><li>인기 시간대</li><li>주차·접근성</li></ul><h2>인기 비교 매치업</h2><ul><li>강남 A클럽 vs B클럽</li><li>홍대 라운지 vs 이태원 라운지</li><li>일산 룸 vs 수원 룸</li><li>부산 호빠 1위 vs 2위</li><li>요정 vs 한정식집</li></ul><h2>비교표 사용 팁</h2><p>두 곳을 동시에 펼쳐서 항목별 우열을 한눈에 확인할 수 있습니다. 후기 키워드 분석으로 강점·약점을 파악하고, 예산 대비 만족도가 높은 곳을 선택하세요. VS 투표 페이지에서 회원들의 실시간 선호도도 확인 가능합니다.</p>`,
  ...
  '/pricing': () => `<h1>요금제 4단계, 0원부터 시작 가능</h1><p>무료 체험 14일 후 결정해도 늦지 않습니다. 해지도 클릭 한 번이면 됩니다.</p><h2>요금제별 기능</h2><ul><li>무료 — 사진 3장, 메뉴 5개, 검색 노출</li><li>스타트 (월 9만원) — 사진·메뉴 무제한</li><li>프로 (월 19만원) — 메인 노출 + 분석</li><li>VIP (월 39만원) — 단독 영역 + 푸시</li></ul><h2>요금제 선택 가이드</h2><ul><li>매장 신규 오픈 — 무료 시작</li><li>월 매출 1000만 미만 — 스타트</li><li>월 매출 1000~5000만 — 프로</li><li>월 매출 5000만 이상 — VIP</li></ul><h2>결제·환불</h2><p>모든 요금제 14일 무료 체험이 제공되며, 체험 기간 내 해지 시 결제되지 않습니다. 카드 자동 결제 또는 계좌이체 가능하고, 법인은 세금계산서 자동 발행됩니다. 해지 시 미사용 일자만큼 일할 환불됩니다.</p>`,
  '/for-business': () => `<h1>사장님, 가게 올리면 월 1,200명이 봅니다</h1><p>14일 무료 체험. 등록만 하면 검색 노출·전화 연결·리뷰 관리 전부 됩니다.</p><h2>입점하면 받는 효과</h2><ul><li>월 평균 1,200건 페이지뷰</li><li>월 평균 120건 전화 클릭</li><li>월 평균 25건 신규 방문</li><li>실시간 리뷰 알림</li><li>주간 분석 리포트</li></ul><h2>경쟁사 대비 차별점</h2><ul><li>광고비 0원 (요금제만)</li><li>업종별 전문 페이지</li><li>모바일 최적화 100%</li><li>카카오 알림 연동</li><li>구글·AI 검색 SEO 최적화</li></ul><h2>입점 절차</h2><p>onboarding 페이지에서 3분이면 신청 완료, 24시간 내 심사 통과, 즉시 노출 시작됩니다. 사업자등록증·매장 사진 3장만 있으면 되고, 14일 무료 체험 후 요금제를 선택하면 됩니다. 케이스 스터디 페이지에서 실제 사례를 확인하세요.</p>`,
};
  ...
  if (['club', 'room', 'yojeong'].includes(cat)) {
    for (const [region, regionKo] of Object.entries(regions)) {
      ...
      if (cat === 'club') {
        ...
        desc = `${regionKo} 클럽 ${regionVenues.length}곳 실시간 비교. ${allNames} 등 입장료·분위기·드레스코드·영업시간·후기·게스트 라인업·부킹 문화·첫방문 매너까지 한눈에 확인하고 골라보세요. EDM·힙합·테크노 ${regionKo} 인기 핫스팟 정리.`;
      } else if (cat === 'room') {
        title = `${regionKo} 룸 ${regionVenues.length}곳 — 인원수 말하면 딱 맞게 세팅`;
        desc = `${regionKo} 프라이빗 룸 ${regionVenues.length}곳 비교. ${allNames} 등 4인 소형부터 30인 단체석까지 인원별 사이즈, 발렌타인·조니워커·로얄살루트 양주 라인업, 룸 구성, 시세, 예약 팁까지 모임 전 필수 체크.`;
      } else {
        title = `${regionKo} 요정 ${regionVenues.length}곳 — 격이 다른 만찬의 시작`;
        desc = `${regionKo} 전통 한정식 요정 ${regionVenues.length}곳. ${allNames} 등 정찬 15첩 코스·국악 라이브·프라이빗 룸 비교. 비즈니스 만찬 외국 손님 접대 장소, 코스 가격대 15~25만원, 예약·드레스코드 매너 가이드까지.`;
      }
...
for (const [catKey, catInfo] of Object.entries(catMap)) {
  ...
  const desc = `전국 ${catInfo.labelKo} 인기 TOP ${catVenues.length}곳 실시간 비교 가이드 — ${topNames} 등 인기 ${catInfo.labelKo} 객단가, 분위기, 후기, 평점, 매니저 평판, 드레스코드, 전화번호, 영업시간, 예약 팁까지 매시간 자동 업데이트되는 ${catInfo.labelKo} 핫스팟 랭킹.`;
...
for (const [catKey, catInfo] of Object.entries(catMap)) {
  ...
  const desc = `최근 새로 오픈한 ${catInfo.labelKo} ${catVenues.length}곳 신규 입점 리스트와 첫방문 가이드. ${newNames} 등 강남 홍대 이태원 일산 부산 수원 신생 핫스팟. 오픈 직후라 손님 적고 서비스 좋은 신규 ${catInfo.labelKo}만 모아 객단가·분위기·예약 팁까지 비교.`;
...
for (const [regionKo, regionVenues] of Object.entries(allRegions)) {
  ...
  const desc = `${regionKo} 지역 클럽·나이트·라운지·룸·요정·호빠 ${regionVenues.length}곳 통합 정리. ${regionTopNames} 등 인기 업소 평점·후기·시세·전화번호 한눈에 비교. ${regionKo} 밤문화 처음 가는 사람도 후회 없이 고르는 핫스팟 가이드.`;
  // 업종별 그룹핑 SSR
  const byCat = {};
  ...
  for (const [catKey, catInfo] of Object.entries(catMap)) {
    ...
    const cd = `${regionKo} ${catInfo.labelKo} ${crossVenues.length}곳 실시간 비교 가이드 — ${crossNames} 등 인기 ${catInfo.labelKo} 객단가, 분위기, 후기, 평점, 매니저 평판, 드레스코드, 전화번호, 영업시간, 예약 팁, 첫방문 동선까지 한눈에 정리한 ${regionKo} 핫스팟 비교 페이지.`;
