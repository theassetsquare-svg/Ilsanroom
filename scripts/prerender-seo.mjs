...
const staticPages = [
  ...
  { path: '/rooms', title: '룸 초이스 한 번이라도 후회해본 사람만 봐요. 10년 실장이 까드림', desc: '사진이랑 다르면 그 순간 분위기 끝납니다. 10년 일한 룸 실장이 초이스·양주 라인·진행 케어까지 매장별로 솔직히. 후회하기 전에 직접 물어봐요 →' },
  { path: '/yojeong', title: '요정에서 격 떨어지면 다음은 없죠 — 20년 실장이 봐드림', desc: '거래처 모실 요정 어디로? 격 떨어지면 다음 자리는 없다, 우리 20년차 실장이 요정 한정식·접대·진행 매너 한 줄로 정리. 강남·일산·부산 진짜 격 있는 곳 바로 확인 →' },
  ...
  { path: '/magazine', title: '밤문화 읽을거리, 여기 다 모았다', desc: '오늘 밤 어디 갈지 망설여? 강남 홍대 이태원 일산 부산 수원 6개 지역 분석, 업종 비교, 신규 매장 현장 리포트까지 우리가 직접 읽고 정리한 글 모음. 모르고 가면 후회, 바로 확인.' },
  ...
  { path: '/community/tips', title: '고수들이 풀어놓은 밤놀이 실전 꿀팁', desc: '어떤 가게가 안전? 초보가 호구되기 전에 무조건 봐. 입장 타이밍·자리 잡는 법·단골 매너까지 1편 정리. 강남 홍대 부산 6개 지역 팁 바로 확인. 후회 전에.' },
  { path: '/community/party', title: '같이 갈 사람 손! 파티 멤버 모집', desc: '혼자 가기 아깝다면? 우리끼리 같이 갈 사람 바로 모집. 클럽 4인 N빵·라운지 짝매칭·룸 단체석·주말 1박2일 클럽투어까지. 인원 채워서 출발, 바로 확인.' },
  { path: '/community/free', title: '아무 말 대잔치, 자유게시판', desc: '오늘 뭐 떠들고 싶어? 잡담 질문 자랑 푸념 황당썰 추천음악 맛집 해장정보 다 OK. 익명 보장, 규칙 1개만 지키면 자유. 밤문화 입문자도 바로 환영.' },
  ...
  { path: '/lounge', title: '업종별 라운지 — 같은 취향끼리 모이는 곳', desc: '나는 어떤 라운지가 맞을까? 나이트·클럽·룸·요정·호빠·라운지바 6개 업종별 전용 게시판. 같은 곳 다녀온 사람끼리 후기·추천·비교 — 익명으로 솔직하게 바로 확인.' },
  { path: '/lounge/night', title: '나이트 라운지 — 다녀온 사람들의 경험담', desc: '강남 부산 수원 일산 광주 6개 지역 나이트 진짜 어떤지 궁금해? 부킹 성공기·부스 분위기·매니저 평판·양주 라인업까지 다녀온 사람들 솔직 후기 바로 확인.' },
  ...
  { path: '/lounge/room', title: '룸 라운지 — 단체석·인원별 인사이더 정보', desc: '몇 명이서 가야 룸이 딱 맞을까? 4인 소형부터 30인 단체석까지 인원별 룸 구성, 양주 라인업 4종, 매니저 평판, 예약 팁 한 페이지에서 바로 확인.' },
  { path: '/lounge/yojung', title: '요정 라운지 — 정찬 코스와 비즈니스 만찬 후기', desc: '거래처 모실 자리 어디로? 전통 요정 정찬 15첩 코스, 국악 라이브, 비즈니스 만찬 후기 5건. 일산명월관·종로요정·강남요정 코스 구성·드레스코드 바로 확인.' },
  { path: '/lounge/hoppa', title: '호빠 라운지 — 여자 혼자 가는 사람들의 안전 후기', desc: '여자 혼자 가도 안전한 데 어디 있어? 강남 종로 영등포 해운대 대구 5개 지역 호빠 분위기·마담 인증·매니저 평판·첫방문 동선·안전 정보 바로 확인.' },
  { path: '/lounge/lounge', title: '라운지바 게시판 — 칵테일·위스키 데이트 후기', desc: '데이트 어디로 가지? 강남 홍대 이태원 일산 부산 5개 지역 라운지바 칵테일·위스키 추천, 야경 좋은 루프탑·호텔 라운지 후기 바로 확인.' },
  { path: '/lounge/free', title: '라운지 자유게시판 — 뭐든 자유롭게', desc: '오늘 뭐 떠들고 싶어? 업종 상관없이 자유롭게 대화하는 라운지. 잡담·질문·황당썰·후기·추천 5가지 다 OK. 강남 홍대 이태원 일산 부산 회원들의 광장, 익명으로 바로 입장.' },
  { path: '/lounge/qna', title: '라운지 질문답변 — 뭐든 물어보세요', desc: '뭐든 물어봐도 돼? 첫방문 매너·강남 홍대 이태원 일산 부산 5개 지역 분위기 비교·업소 추천·안전 팁·드레스코드까지 단골 회원들이 바로 답변하는 실시간 Q&A.' },

  // Launch & Privacy
  { path: '/welcome', title: '처음 오셨다면 — 익명 가입·후기·찜 한 번에', desc: '처음이라 어디부터 봐야 해? 본명·주민번호 없이 닉네임 하나로 가입, 6업종 분위기·라인업·후기 비교. 우리 회원들이 모인 커뮤니티 바로 확인.' },
  { path: '/privacy-promise', title: '프라이버시 보호 정책 — 익명 활동 원칙', desc: '내 정보 어디까지 안전한가? 본명·주민번호는 받지 않는다. 닉네임만 노출, 팝업 최소, 탈퇴 시 즉시 삭제 4가지 약속 한 페이지에서 바로 확인.' },
  ...
  { path: '/disclaimer', title: '법적 고지·면책사항 — 사이트 이용 전 꼭 확인', desc: '내가 본 정보 어디까지 믿어도 되나? 본 사이트 정보는 참고 목적. 업소 변경 책임 한계·외부 링크·광고성 글 처리 5가지 명확히 바로 확인.' },
  ...
  { path: '/legal', title: '법적 준수 안내 — 정보통신망법·청소년보호법·개인정보보호법', desc: '본 플랫폼이 준수하는 국내 법령과 운영 원칙을 한 페이지에서 확인하세요. 청소년 보호, 콘텐츠 검수, 개인정보 처리, 신고 창구까지 운영 책임 범위를 투명하게 공개합니다.' },
  ...
  { path: '/case-studies', title: '잘 되는 매장만 모아둔 운영 사례집 — 입소문 핫플의 공통점', desc: '내 매장만 손님 안 오는 이유 뭘까? 잘 되는 곳들이 공통적으로 챙기는 5가지 항목 정리. 가공된 매출 수치 없이 실제 확인 항목만 바로 확인.' },
  ...
  { path: '/lead/weekly-hot', title: '이번 주 핫플 큐레이션 — 준비 중', desc: '이번 주 진짜 핫한 곳 어디지? 커뮤니티 후기·검색 추이 종합한 주간 큐레이션 준비 중. 검증된 결과만 회원에게 바로 공유.' },
  ...
  { path: '/budget', title: '어떤 자리를 찾고 있나 — 상황별 코스 4가지', desc: '편한 자리? 단체? 접대? 데이트? 상황별로 분위기·구성 맞는 곳 4가지 코스로 정리. 처음이라 어디부터 봐야 할지 모르면 바로 확인.' },
  { path: '/occasion', title: '어떤 자리야 — 6가지 상황별 핫플 정리', desc: '나이트라이프 첫 방문? 거래처 접대? 친구 생일? 데이트? 6가지 상황별로 맞는 곳 큐레이션 — 처음 가는 사람도 헛걸음 0번 만들자.' },
  ...
  { path: '/referral', title: '친구 초대하고 등급 올리기 — 매너있는 회원만 모이는 법', desc: '같이 다닐 친구 없어 망설였어? 우리 회원에게 1대1 초대 링크 보내면 등급이 같이 올라간다. 적립 정책은 운영 문서, 부정 가입은 자동 차단. 친한 분에게만 바로 보내자.' },
  ...
  { path: '/gallery', title: '가기 전에 분위기부터 — 매장 내부 실제 사진 갤러리', desc: '사진 안 보고 가서 후회한 적 없어? 조명·룸 배치·무대 분위기·라인업 4가지 가기 전 눈으로 바로 확인. 카테고리·지역별 정리.' },
  { path: '/events', title: '이번 주 갈만한 이벤트 — DJ 게스트·시즌 파티 일정', desc: '이번 주 어디서 뭐 한대? 놓치면 아까운 DJ 게스트·시즌 이벤트·코스튬 파티 4가지 일정 한눈에. 정확한 정보는 매장 페이지에서 바로 확인.' },

  // Auth & Admin (SEO 가치 낮지만 고유 title 설정)
  { path: '/login', title: '카카오·네이버·구글 로그인', desc: '회원 안 하면 찜·후기 어디 가? OAuth 1번 로그인이면 끝. 본명·주민번호 입력 없이 닉네임만으로 바로 활동.' },
  { path: '/profile', title: '내 찜·후기·활동 기록', desc: '내 활동 어디서 다 모아보지? 찜한 업소·작성 후기·포인트·등급·알림 설정 5가지 한 곳에서 바로 확인. 닉네임만 노출, 본명은 비공개.' },
  { path: '/dashboard', title: '업주 대시보드', desc: '내 매장 오늘 몇 명 들어왔지? 페이지뷰·전화 클릭·찜·후기 4가지 지표 한눈에 바로 확인. 모바일에서도 동일.' },
  { path: '/analytics', title: '유입 경로·전환 분석 리포트', desc: '내 매장에 어디서 어떻게 들어오는지 모르면 마케팅 헛돈만 쓴다. 요일·시간대·유입 경로·전화 클릭률 5가지 지표 한 화면에서 바로 확인.' },
  { path: '/billing', title: '구독·결제 내역 관리', desc: '내 결제 어떻게 빠져나가고 있나? 현재 요금제·결제 이력·결제수단 변경·해지까지 4가지 한 페이지에서 바로 처리. 환불 정책은 약관에서 확인.' },
  ...
  { path: '/admin', title: '관리자 대시보드', desc: '오늘 어디부터 손볼까? 매장·매거진·미디어·SEO·블록·모더레이션 9가지 도구를 한 화면 사이드바에서 바로 진입.' },
  { path: '/admin/venues', title: '매장 수정·삭제', desc: '어느 업소부터 손볼까? 등록된 모든 업소 한 화면에서 일괄 관리. 정보 수정·사진 교체·영업 상태 토글·신고 처리·SEO 메타까지 7가지 권한 바로 확인.' },
  { path: '/admin/magazine', title: '매거진 글 작성·예약', desc: '오늘 어떤 이야기 풀까? WYSIWYG 에디터로 본문 작성, 커버 이미지 지정, 시간대 예약 발행까지 한 화면에서 마무리.' },
  { path: '/admin/media', title: '미디어 라이브러리', desc: '사진은 어디서 찾지? 업로드·갤러리·삭제·복사까지 한 곳에서 처리, 매거진과 매장 페이지에 바로 삽입.' },
  { path: '/admin/seo', title: 'SEO 메타 덮어쓰기', desc: '어떤 페이지부터 손볼까? 페이지별 title·description·og 이미지를 전역 훅으로 덮어써서 검색 노출 즉시 보강.' },
  { path: '/admin/blocks', title: '페이지 블록 카피 편집', desc: '홈 히어로 문구 바꾸고 싶을 때, 페이지 키와 블록 키로 카피를 직접 덮어써서 코드 배포 없이 즉시 반영.' },
  { path: '/admin/moderation', title: '모더레이션 — 신고·숨김·정지', desc: '오늘 신고 몇 건 들어왔지? 신고 큐, 숨김 콘텐츠, 유저 정지 3탭에서 커뮤니티 안전 한 화면 처리.' },
  { path: '/admin/stats', title: '운영 통계 한눈에', desc: '오늘 회원·글·후기 얼마나 늘었지? 일·주·월 단위 운영 지표를 카드 그리드로 확인.' },
  { path: '/admin/visitors', title: '방문자 행동 분석', desc: '오늘 방문자는 어디까지 보고 갔지? 페이지별 체류·이탈·스크롤 깊이를 실제 page_events 로그 기반으로 분석.' },
  { path: '/admin/audit', title: '감사 리포트', desc: '오늘 사이트 점수는? title 중복·후킹·링크 깨짐·금지어 자동 점검 결과를 한 페이지에서 확인.' },
