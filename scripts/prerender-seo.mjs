...
const staticPages = [
  ...
  { path: '/clubs', title: '클럽 — 입장 진짜 되나요? 10년차 MD가 봐드립니다', desc: '이 클럽, 진짜 갈 만한가요? 입장 컷·물·DJ 라인업을 10년차 현장 MD가 1줄 진단 — 주말 망치고 택시비 날리기 전에. 지금 무료 →' },
  { path: '/nights', title: '나이트 — 부킹 진짜 잘 잡히나요? 10년차 웨이터가 봐드립니다', desc: '이 나이트, 부킹 진짜 되나요? 홀·부스·물·진행을 10년차 현장 웨이터가 1,000+ 업소 데이터로 1줄 진단 — 1차로 끝낼 곳 vs 갈 곳. 지금 무료 →' },
  { path: '/lounges', title: '라운지 — 분위기 진짜 좋나요? 10년차 실장이 봐드립니다', desc: '이 라운지, 진짜 분위기 있나요? 인테리어·시그니처·만남 결을 10년차 현장 실장이 1줄 진단 — 어색한 자리 망치기 전에. 지금 무료 →' },
  { path: '/rooms', title: '룸 — 초이스 진짜 만족하나요? 10년차 실장이 봐드립니다', desc: '이 룸, 진짜 갈 만한가요? 초이스·양주 라인·진행 케어를 10년차 현장 실장이 1줄 진단 — 후회하기 전에 진짜 좋은 곳만. 지금 무료 →' },
  { path: '/yojeong', title: '요정 — 격조 진짜 다른가요? 20년차 실장이 봐드립니다', desc: '이 요정, 진짜 격조 있나요? 한정식·접대·진행 매너를 20년차 현장 실장이 1줄 진단 — 어른 자리 망치기 전에. 진짜 격이 있는 곳만. 지금 무료 →' },
  { path: '/hoppa', title: '호빠 — 선수 진짜 괜찮나요? 10년차 실장이 봐드립니다', desc: '이 호빠, 선수 진짜 괜찮나요? 외모·매너·진행을 10년차 현장 실장이 1줄 진단 — 어색한 시간 날리기 전에. 진짜 케어되는 곳만. 지금 무료 →' },
...
writePage('/', {
  title: '놀쿨 — 이 가게 가도 될까요? 20년차 현장이 봐드립니다',
  description: `이 가게, 진짜 갈 만한가요? 물·라인업·진행을 20년차 현장이 ${venues.length}+ 업소 데이터로 1줄 진단. 주말 망치기 전에 — 지금 무료 →`,
