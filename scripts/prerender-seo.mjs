...
const INTERACTIVE_PAGE_BLURBS = {
  '/cafe': () => `<h1>놀쿨 카페는 두 곳입니다</h1><p>1관은 처음 가는 분을 위한 정보, 2관은 다니는 분을 위한 소식입니다. 만 19세 이상만 이용합니다.</p><h2>1관 정보 — 전국 나이트클럽 정보·후기</h2><p><a href="https://cafe.naver.com/qotjsdnr?utm_source=nolcool&amp;utm_medium=cafe_page&amp;utm_campaign=hall1" target="_blank" rel="noopener">1관 정보 카페로 가기</a> — 위치·영업시간·주차·복장·가는 길을 모아 둔 곳입니다.</p><h2>2관 소식 — 전국 나이트 이벤트·소식</h2><p><a href="https://cafe.naver.com/beasunwook?utm_source=nolcool&amp;utm_medium=cafe_page&amp;utm_campaign=hall2" target="_blank" rel="noopener">2관 소식 카페로 가기</a> — 이벤트·행사·시간대 팁을 올리는 곳입니다.</p><h2>어느 카페로 갈지 한눈에</h2><table><thead><tr><th>항목</th><th>내용</th></tr></thead><tbody><tr><td>1관</td><td>위치·영업시간·주차·복장·가는 길</td></tr><tr><td>2관</td><td>이벤트·행사·시간대 팁</td></tr><tr><td>공통</td><td>만 19세 이상 · 운영 놀쿨(nolcool.com) · 광고·제휴 문의 카카오톡 besta12</td></tr></tbody></table><p>가짜 후기·가짜 회원은 만들지 않습니다. 운영자 글은 놀쿨 이름으로만 올립니다.</p>`,
