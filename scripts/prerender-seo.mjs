...
const CROSS_SIG = {
  ...
  hoppa: {
    '장안동': { tail: '장한평 실장이 호스트 초이스 돕는 자리', sig: '장한평 실장이 호스트 초이스를 돕는 자리' },
    ...
    '대전':   { tail: '갤러리아 실장 호스트 초이스 라인',     sig: '갤러리아 실장 호스트 초이스 라인' },
    '홍대':   { tail: '연남 실장 호스트 추천 도는 곳',         sig: '연남 실장이 호스트를 추천해 도는 곳' },
    '화양동': { tail: '화양리 실장 호스트 매칭 자리',         sig: '화양리 실장 호스트 매칭 자리' },
    '건대':   { tail: '화양리 실장 골라주는 호스트 무대',     sig: '화양리 실장이 골라주는 호스트 무대' },
    '부산':   { tail: '서면 실장 호스트 초이스 빠른 라인',     sig: '서면 실장 호스트 초이스가 빠른 라인' },
