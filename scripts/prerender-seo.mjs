...
const staticPages = [
  ...
  // Community pages
  { path: '/community', title: '밤 사람들이 모이는 커뮤니티', desc: '강남 홍대 이태원 일산 부산 클럽 나이트 라운지 룸 요정 호빠 후기 꿀팁 파티모집 Q&A 자유게시판 패션 조각모임. 매일 새 글 200개 이상 올라오는 진짜 회원 광장. 익명 보장.' },
  ...
  { path: '/community/tips', title: '고수들이 풀어놓은 밤놀이 실전 꿀팁', desc: '입장 타이밍, 자리 잡는 법, 안 당하는 법, 시세 협상 노하우까지. 경험자만 아는 실전 가이드. 강남 홍대 이태원 일산 수원 부산 지역별 꿀팁과 안전 팁 총정리.' },
  { path: '/community/party', title: '같이 갈 사람 손! 파티 멤버 모집', desc: '날짜 맞추고 인원 채우고 N빵으로 비용 분담. 혼자 가기 아까울 때 여기서 구해. 클럽 4인 N빵, 라운지 짝매칭, 룸 단체석, 출장 동행까지 빠른 매칭 게시판.' },
  { path: '/community/free', title: '아무 말 대잔치, 자유게시판', desc: '잡담 질문 자랑 푸념 다 OK. 매일 새 글 200개 이상 올라오는 자유게시판. 익명 보장, 규칙만 지키면 뭐든 자유롭게 쓸 수 있어요. 밤문화 입문자 환영.' },
