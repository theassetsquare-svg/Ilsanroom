...
function generateVenueSsrBody(v, allVenues) {
  ...
  if (v.cat === 'night' || v.cat === 'club') {
    ...
    html += `${name} 양주 라인업은 캐주얼부터 프리미엄까지 폭넓어 접대·회식·모임에 적합하다.</p>`;
  } else if (v.cat === 'hoppa') {
...
const staticPages = [
  ...
  { path: '/lounge/night', title: '나이트 라운지 — 나이트 경험담 공유', desc: '강남 부산 수원 일산 광주 평택 나이트 다녀온 사람들의 실시간 이야기. 부킹 성공기, 부스 분위기, 매니저 평판, 양주 라인업 비교까지. 솔직 후기와 질문이 오가는 나이트 전용 게시판.' },
  ...
  { path: '/lounge/room', title: '룸 라운지 — 룸 이야기', desc: '일산 강남 수원 부산 해운대 룸 이용 후기와 추천 정보. 4인 소형부터 30인 단체석까지 인원별 룸 구성, 발렌타인 12·17년 조니워커 블루 로얄살루트 양주 라인업, 매니저 평판, 예약 팁, 단골 인사이더 공유.' },
  { path: '/lounge/yojung', title: '요정 라운지 — 요정 이야기', desc: '전통 요정 방문 경험과 정보 공유. 정찬 15첩 코스, 국악 라이브, 비즈니스 만찬 후기. 일산명월관·종로요정·강남요정 등 코스 구성, 드레스코드, 예약 매너까지.' },
  { path: '/lounge/hoppa', title: '호빠 라운지 — 호빠 이야기', desc: '여성 전용 사교 공간 호빠 방문 후기·추천. 강남 종로 영등포 해운대 대구 분위기, 마담 인증, 매니저 평판, 첫방문 동선, 안전 정보, 카드 결제 가능 업소까지. 여자 혼자 가도 안전한 호빠 정보 전용 게시판.' },
  { path: '/lounge/lounge', title: '라운지바 라운지 — 라운지바 이야기', desc: '강남 홍대 이태원 일산 부산 라운지바 분위기·칵테일·위스키 추천 게시판. 데이트 코스, 접대용 프라이빗 라운지, 야경 좋은 루프탑·호텔 라운지 후기. 분위기별 추천과 매너 공유.' },
  ...
  // Launch & Privacy
  { path: '/welcome', title: '놀쿨 OPEN BETA — 창립멤버 100명 한정 모집', desc: '놀쿨이 막 열렸습니다. 첫 100명 창립멤버에게 영구 ⭐ 뱃지. 카톡 공유 안전 + 본명 X + Stealth 모드. 친구한테 추천해도 걱정 없는 유흥 가이드. 전국 클럽·나이트·라운지·룸·요정·호빠 한 곳에서.' },
  { path: '/privacy-promise', title: '놀쿨 프라이버시 6대 약속 — 친구한테 추천해도 안전한 이유', desc: '카톡 공유 위장, 본명 절대 X, 신상털림 차단, Stealth 모드, 시크릿 안내, 결제 표기 중립. 백만 사용자 프라이버시를 지키는 6대 약속 전문 공시. 가족·연인 폰 들켜도 안전한 유흥 플랫폼.' },
  ...
  // Business
  { path: '/for-business', title: '사장님, 가게 올리면 월 1,200명이 봅니다', desc: '14일 무료 사용으로 시작. 등록만 하면 구글·네이버 검색 노출, 전화 연결, 리뷰 관리, 통계 대시보드 전부 가능. 강남·홍대·일산 등 핵심 지역 사장님 200명 입점. 카톡 besta12 문의.' },
...
const INTERACTIVE_PAGE_BLURBS = {
  ...
  '/for-business': () => `<h1>사장님, 가게 올리면 월 1,200명이 봅니다</h1><p>14일 무료 사용. 등록만 하면 검색 노출·전화 연결·리뷰 관리 전부 됩니다.</p><h2>입점하면 받는 효과</h2><ul><li>월 평균 1,200건 페이지뷰</li><li>월 평균 120건 전화 클릭</li><li>월 평균 25건 신규 방문</li><li>실시간 리뷰 알림</li><li>주간 분석 리포트</li></ul><h2>경쟁사 대비 차별점</h2><ul><li>광고비 0원 (요금제만)</li><li>업종별 전문 페이지</li><li>모바일 최적화 100%</li><li>카카오 알림 연동</li><li>구글·AI 검색 SEO 최적화</li></ul><h2>입점 절차</h2><p>onboarding 페이지에서 3분이면 신청 완료, 24시간 내 심사 통과, 즉시 노출 시작됩니다. 사업자등록증·매장 사진 3장만 있으면 되고, 14일 무료 사용 후 요금제를 선택하면 됩니다. 케이스 스터디 페이지에서 실제 사례를 확인하세요.</p>`,
};
