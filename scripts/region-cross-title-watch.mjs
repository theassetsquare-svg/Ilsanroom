...
const CROSS_SIG = {
  night: {
    '광주': '상무지구 새벽까지 합석 도는 코스', '대전': '둔산동 트로트 라이브부터 중앙로 38세+ 홀까지',
  ...
  hoppa: {
    // '해운대' 항목 제거(2026-08-02): venue regionKo는 전부 '부산 해운대'라 /region/해운대/hoppa/ 페이지는
    // prerender가 생성한 적 없음(라이브 404 실측) — 실존 페이지는 아래 '부산 해운대'가 커버. 매일 404 거짓경보 종결.
    '장안동': '장한평 실장이 호스트 셀렉션 돕는 자리',
