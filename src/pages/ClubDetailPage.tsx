...
const defaultFaqs = (name: string) => [
  ...
  { question: `재입장이 가능한가요?`, answer: `대부분의 클럽은 손등 스탬프나 팔찌를 통해 당일 재입장을 허용합니다. 다만 일부 특별 이벤트나 페스티벌 파티에서는 재입장이 제한될 수 있으니 입장 시 직원에게 미리 확인하세요.` },
  ...
  { question: `피크 타임과 한산한 시간대는 언제인가요?`, answer: `금·토요일 자정~새벽 2시가 가장 붐비는 피크 타임이며, 오픈 직후인 밤 10~11시는 비교적 여유롭게 입장할 수 있습니다. 평일은 수요일·목요일 레이디스 나이트 같은 특별 이벤트가 있는 날이 활발합니다.` },
  { question: `주변 주차장과 대리운전은 이용 가능한가요?`, answer: `클럽 주변 공영주차장이나 민영주차장을 이용할 수 있으며, 야간 주차 요금은 1시간당 2,000~4,000원 수준입니다. 귀가 시 카카오T 대리나 클럽 앞 대리운전 기사를 쉽게 잡을 수 있습니다.` },
];
