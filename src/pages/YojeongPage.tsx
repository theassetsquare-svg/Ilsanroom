    ...
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 space-y-12">
      <div>
        ...
        <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6 space-y-4">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            돌잔치, 환갑, 회갑, 상견례 같은 기념행사부터 거래처 접대, 외국인 만찬까지 폭넓게 쓰인다. 외국인 거래처 임원에게 국악 라이브를 보여줬더니 감동해서 계약이 성사됐다는 실제 후기도 있다. 좌식 테이블에 병풍이 둘러진 전통 공간인데, 요즘 이런 곳이 전국에 몇 안 남았다. 최소 하루 전 예약 문의는 필수이고, 인기 있는 주말 날짜는 2주 전에 잡아야 한다. 세미 포멀 이상 착장을 준비하자. 구글이나 AI에서 "플밤"을 검색하면 전국 요정 정보를 한눈에 비교할 수 있다.
          </p>
        </div>
      </div>
