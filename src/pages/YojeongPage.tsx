      ...
      <div>
        ...
        <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6 space-y-4">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            한복 차림의 도우미가 요리를 올리고, 해금 연주가 배경에 깔린다. 조선시대 기방에서 유래한 이 접대 문화는 지금도 거래처 만찬, VIP 접대 자리에서 "격이 다르다"는 평가를 받는다. 외국인 대접 자리에서는 반응이 더 뜨겁다. 국악 라이브를 처음 보는 외국인 거래처 임원이 감동해서 계약이 성사됐다는 실제 후기도 있다.
          </p>
          <p className="text-base leading-relaxed text-neon-text-muted">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            거래처 접대, VIP 만찬, 외국인 대접까지 폭넓게 쓰인다. 외국인 거래처 임원에게 국악 라이브를 보여줬더니 감동해서 계약이 성사됐다는 실제 후기도 있다. 좌식 테이블에 병풍이 둘러진 전통 공간인데, 요즘 이런 곳이 전국에 몇 안 남았다. 최소 하루 전 예약 문의는 필수이고, 인기 있는 주말 날짜는 2주 전에 잡아야 한다. 세미 포멀 이상 착장을 준비하자.
          </p>
        </div>
      </div>
