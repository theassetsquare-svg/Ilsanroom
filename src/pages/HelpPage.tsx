...
const faqCategories: FaqCategory[] = [
    ...
    items: [
      {
        ...
        answer:
          "당사는 나이트라이프 매장(룸, 라운지, 클럽, 요정 등)를 위한 올인원 디지털 플랫폼입니다. 매장 검색, 방문후기, 예약, 커뮤니티 도구가 갖춰져 있고, 업주에게는 게재 관리, 데이터 인사이트, 예약 체계 등 전문 수단도 쓸 수 있습니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "플랜·단가는 어떻게 안내되나요?",
        answer:
          "지역·업종·규모에 맞춰 단가를 협의 후 안내드립니다. 일률적인 요금표를 두지 않고, 필요한 노출만 선택하실 수 있도록 카카오톡 besta12로 상세 상담을 받습니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        question: "처음 등록할 때 비용이 발생하나요?",
        answer:
          "업소 등록 자체는 무료이며, 노출 위치·기간에 따라 광고 옵션을 별도로 선택할 수 있습니다. 자세한 단가는 카카오톡 besta12 상담을 통해 안내드립니다.",
      },
      {
        question: "결제는 어떻게 진행되나요?",
        answer:
          "현재 카드 결제 시스템은 준비 중입니다. 광고·입점은 카카오톡 besta12 상담 후 개별 안내로 진행됩니다.",
      },
    ],
  },
  {
