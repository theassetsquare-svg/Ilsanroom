...
const guides = [
  {
    ...
    budget: '음료·테이블 예약 위주. 분위기·드레스코드 위주로 매장별 차이를 확인.',
  ...
  },
  {
    ...
    budget: '양주 위주 운영. 부스/룸 구성과 웨이터 매너는 매장별 확인.',
  ...
  },
  {
    ...
    budget: '칵테일·시그니처 드링크 중심. 독립 부스는 최소 주문이 있을 수 있음.',
  ...
  },
  {
    ...
    budget: '룸 이용 + 음료 구성. 매장마다 다르니 전화 문의 필수.',
    alone: '보통 2인 이상 이용. 1인 이용 가능 여부 매장에 확인.',
    manner: '시설 소중히. 퇴실 시간 준수.',
    bestTime: '평일 저녁 모임, 주말 친구 모임.',
        ...
        <ReadCompletionReward teaser="끝까지 읽은 사람만 보는 첫 방문 꿀팁">
          <div className="space-y-3">
            ...
            <ul className="text-sm text-[#555] space-y-2" style={{ lineHeight: '1.7' }}>
              ...
              <li>3. <strong>다음 갈 곳</strong>까지 미리 정해놓고 가면 밤이 훨씬 알차다</li>
            </ul>
          </div>
