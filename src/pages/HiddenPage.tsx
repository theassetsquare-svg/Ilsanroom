...
export default function HiddenPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <p className="text-neon-text-muted mb-10">매주 발굴하는 숨은 밤문화 명소</p>

      <div className="space-y-6">
        {hiddenGems.map((gem) => (
          <Link key={gem.name} href={gem.href} className="block rounded-2xl border border-neon-border bg-neon-surface p-6 transition hover:border-neon-primary/40 card-hover">
