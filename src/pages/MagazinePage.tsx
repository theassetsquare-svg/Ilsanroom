...
const articles = [
  ...
  },
  {
    ...
    excerpt: '일산명월관요정은 30개 프라이빗 룸과 15가지 한정식 코스를 갖춘 일산 대표 전통 공간입니다. 비즈니스 접대·기념일·각종 기념일 활용법을 정리했습니다.',
    tag: '요정',
    date: '2026-03-10',
    readMin: 7,
  },
  ...
  },
  {
    ...
    excerpt: '서울·부산·대구·대전·울산·수원·인천 등 전국 주요 도시별 댄스홀 문화를 정리합니다. 도시마다 다른 분위기와 추천 장소를 모아뒀다.',
    tag: '정보',
    date: '2026-02-28',
    readMin: 10,
  },
...
export default function MagazinePage() {
  useDocumentMeta('읽다 보면 가고 싶어지는 야간 매거진', '강남 TOP5, 첫 방문 핸드북, 지역별 분석 콘텐츠.');
  return (
