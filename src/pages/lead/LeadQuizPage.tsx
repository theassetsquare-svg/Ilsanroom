...
function getRecommendation(answers: QuizAnswer) {
  ...
  return {
    ...
    description:
      answers.vibe === 'calm'
        ? '조용한 대화와 분위기 있는 공간을 선호하시는군요. 프라이빗한 라운지나 칵테일바가 딱 맞습니다. 예약하고 가면 대기 없이 바로 입장 가능한 곳들이 어울려요.'
        : answers.vibe === 'moderate'
        ? '적당한 활기 속에서 즐기는 타입이시네요. 음악은 있지만 대화가 되는 곳, 안주가 맛있는 곳 위주로 골라드릴게요. 자리 옮기지 않고 한 곳에서 해결되는 곳들이에요.'
        : '에너지 넘치는 밤을 즐기시는 분이군요! 사운드 시스템 좋고, DJ 라인업 탄탄한 곳 위주로 골라드릴게요. 금토 자정 이후가 피크타임이에요.',
  };
}
