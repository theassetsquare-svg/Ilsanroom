...
const defaultFaqs = (name: string) => [
  { question: `${name}은 예약 필수인가요, 워크인도 가능한가요?`, answer: `평일 저녁에는 워크인 입장이 비교적 수월하지만, 주말이나 공휴일 전야에는 만석인 경우가 많아 최소 하루 전 예약을 권장합니다. 카카오톡이나 전화로 간편하게 예약할 수 있습니다.` },
  ...
  { question: `시그니처 칵테일 메뉴가 있나요?`, answer: `각 라운지마다 바텐더가 직접 개발한 시그니처 칵테일을 2~5종 이상 보유하고 있습니다. 소주·막걸리를 활용한 한국식 퓨전 칵테일부터 클래식 칵테일 변주까지 독창적인 메뉴를 경험할 수 있습니다.` },
  ...
  { question: `운영 시간과 라스트 오더는 언제인가요?`, answer: `대부분 오후 6시~새벽 2시 사이에 운영하며, 라스트 오더는 마감 30분~1시간 전에 마감됩니다. 금·토요일에는 새벽 3시까지 연장 운영하는 곳도 있으니 방문 전 확인하세요.` },
  { question: `발렛 파킹 서비스를 이용할 수 있나요?`, answer: `프리미엄 라운지 대부분은 무료 또는 유료 발렛 파킹 서비스를 운영합니다. 발렛비는 보통 5,000~10,000원 수준이며, 일정 금액 이상 이용 시 무료로 전환되는 곳도 있습니다.` },
  { question: `특별 이벤트나 프라이빗 파티 예약이 되나요?`, answer: `생일 파티, 기업 행사, 소규모 세미나 등 맞춤형 이벤트를 진행할 수 있습니다. 2주 이상 전에 인원·예산·콘셉트를 알려주면 전담 매니저가 공간 세팅부터 케이터링까지 원스톱으로 준비해 줍니다.` },
];
