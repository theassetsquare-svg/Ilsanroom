...
const JOGAK_RULES = [
  ...
  { icon: '💰', title: '비용 분담 명확히', desc: '비용 분담 방식(엔빵·각자·초대)을 게시글에 명시. 모임 전 댓글로 합의 권장.' },
...
export default function JogakPage() {
  useDocumentMeta(
    '조각모임 — 같이 갈 사람 바로 구하기',
    '자리 하나 남았을 때 바로 올리고 바로 구하는 조각 매칭판. 여성조각·남성조각·제휴조각·벙개까지 실시간 모집. 강남 홍대 이태원 일산 클럽·룸·라운지 자리 채우기. 100P 이상 작성 가능.'
  );
  ...
  const seedPosts: JogakPost[] = [
    { id: 'seed-1', authorId: null, title: '토요일 강남 레이스 테이블 같이 갈 분', author: '강남조각왕', date: '2026-04-18', comments: 7, region: '강남', jogakType: '테이블', venue: '레이스', meetDate: '2026-04-19', meetTime: '22:00', maxPeople: 6, currentPeople: 3, genderPref: '남녀 혼성', ageRange: '20대후반~30대초반', costSplit: '모든비용 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 필수', message: '분위기 좋게 놀아요. 노쇼 없는 분만 신청해주세요.', jogakCategory: 'female' },
    { id: 'seed-2', authorId: null, title: '홍대 헌팅 같이 돌 사람 구함', author: '홍대프리맨', date: '2026-04-18', comments: 11, region: '홍대', jogakType: '헌팅', venue: '', meetDate: '2026-04-18', meetTime: '23:00', maxPeople: 4, currentPeople: 2, genderPref: '남성만', ageRange: '20대', costSplit: '각자 부담', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 안 함', message: '각자 부담으로 자유롭게 헌팅합시다. 같이 다니면 성공률 높아짐ㅋ', jogakCategory: 'male' },
    { id: 'seed-3', authorId: null, title: '일산 라운지 여성조각 모집해요', author: '일산언니', date: '2026-04-17', comments: 5, region: '일산', jogakType: '테이블', venue: '아르쥬', meetDate: '2026-04-19', meetTime: '21:30', maxPeople: 4, currentPeople: 2, genderPref: '여성만', ageRange: '25~32세', costSplit: '주대만 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 쪽지', photoExchange: '사진교환 필수', message: '분위기 좋은 라운지에서 와인 한잔 해요. 편한 분위기 좋아하는 분만~', jogakCategory: 'female' },
    ...
    { id: 'seed-5', authorId: null, title: '부산 해운대 클럽 주말 조각', author: '해운대조각', date: '2026-04-17', comments: 4, region: '부산', jogakType: '테이블', venue: '고구려', meetDate: '2026-04-19', meetTime: '22:30', maxPeople: 8, currentPeople: 4, genderPref: '남녀 혼성', ageRange: '20대~30대', costSplit: '모든비용 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 선택', message: '남녀 비율 맞춰서 모집 중. 부산 분들 많이 와주세요.', jogakCategory: 'club_lounge' },
    { id: 'seed-6', authorId: null, title: '대전 둔산동 토요 헌팅 같이 가실?', author: '대전형', date: '2026-04-18', comments: 6, region: '대전', jogakType: '헌팅', venue: '', meetDate: '2026-04-19', meetTime: '23:00', maxPeople: 4, currentPeople: 2, genderPref: '남성만', ageRange: '20대후반~30대', costSplit: '각자 부담', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 안 함', message: '둔산동 나이트 자주 가는데 같이 다닐 형 구합니다.', jogakCategory: 'male' },
    { id: 'seed-7', authorId: null, title: '강남 버뮤다 토요일 여성 2명 더', author: '버뮤다단골녀', date: '2026-04-18', comments: 13, region: '강남', jogakType: '테이블', venue: '버뮤다', meetDate: '2026-04-19', meetTime: '22:30', maxPeople: 4, currentPeople: 2, genderPref: '여성만', ageRange: '20대중반~30대초반', costSplit: '모든비용 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 쪽지', photoExchange: '사진교환 필수', message: '버뮤다 자주 가는데 이번에 여자끼리 테이블 잡으려구요. 사진 교환 필수!', jogakCategory: 'female' },
    { id: 'seed-8', authorId: null, title: '수원 나이트 금요 벙개 급구', author: '수원밤새', date: '2026-04-18', comments: 3, region: '수원', jogakType: '헌팅', venue: '', meetDate: '2026-04-18', meetTime: '22:00', maxPeople: 3, currentPeople: 1, genderPref: '누구나', ageRange: '20대~30대', costSplit: '각자 부담', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 안 함', message: '오늘 갑자기 약속 깨져서 같이 나갈 사람 급구ㅠㅠ', jogakCategory: 'bungae' },
    { id: 'seed-9', authorId: null, title: '이태원 라운지 혼성 조각 모집', author: '이태원러버', date: '2026-04-17', comments: 8, region: '이태원', jogakType: '테이블', venue: '', meetDate: '2026-04-19', meetTime: '21:00', maxPeople: 6, currentPeople: 3, genderPref: '남녀 혼성', ageRange: '25~35세', costSplit: '모든비용 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 쪽지', photoExchange: '사진교환 선택', message: '이태원 분위기 좋은 라운지에서 남녀 3:3 맞추려고 합니다.', jogakCategory: 'club_lounge' },
    { id: 'seed-10', authorId: null, title: '대구 동성로 다음주 금요 테이블', author: '대구오빠', date: '2026-04-18', comments: 2, region: '대구', jogakType: '테이블', venue: '', meetDate: '2026-04-25', meetTime: '22:00', maxPeople: 6, currentPeople: 1, genderPref: '남녀 혼성', ageRange: '20대', costSplit: '주대만 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 선택', message: '대구 동성로 클럽 테이블 잡을 건데 미리 모집합니다. 여유있게 준비해요.', jogakCategory: 'male' },
    { id: 'seed-11', authorId: null, title: '홍대 금요일 여자끼리 클럽 가요', author: '홍대공주', date: '2026-04-17', comments: 10, region: '홍대', jogakType: '헌팅', venue: '', meetDate: '2026-04-18', meetTime: '23:00', maxPeople: 4, currentPeople: 2, genderPref: '여성만', ageRange: '20대', costSplit: '각자 부담', contactMethod: '놀쿨 쪽지', photoExchange: '사진교환 필수', message: '홍대 클럽 여자끼리 가면 더 재밌잖아요ㅋㅋ 같이 놀아요!', jogakCategory: 'female' },
    { id: 'seed-12', authorId: null, title: '일산 찬스돔 토요 조각 급모집', author: '일산클럽러', date: '2026-04-18', comments: 14, region: '일산', jogakType: '테이블', venue: '찬스돔', meetDate: '2026-04-19', meetTime: '22:00', maxPeople: 8, currentPeople: 5, genderPref: '남녀 혼성', ageRange: '20대후반~30대', costSplit: '모든비용 엔빵', tableCost: '', perPerson: '', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 필수', message: '찬스돔 테이블 잡아놨는데 3자리 남았어요. 노쇼하면 차단입니다.', jogakCategory: 'club_lounge' },
    { id: 'seed-13', authorId: null, title: '인천 부평 헌팅 같이 다닐 형', author: '부평야행', date: '2026-04-18', comments: 5, region: '인천', jogakType: '헌팅', venue: '', meetDate: '2026-04-19', meetTime: '23:00', maxPeople: 3, currentPeople: 1, genderPref: '남성만', ageRange: '20대후반~30대초반', costSplit: '각자 부담', contactMethod: '놀쿨 댓글', photoExchange: '사진교환 안 함', message: '부평 나이트 같이 다닐 형 구합니다. 저 혼자 매주 가는데 심심해서ㅋㅋ', jogakCategory: 'male' },
    ...
    <div className="mx-auto max-w-3xl px-4 py-6 sm:py-10">
      ...
      {showWrite && (
        <div className="fixed inset-0 z-[100] flex flex-col bg-white">
          ...
          {/* 하단 버튼 */}
          <div className="fixed bottom-14 md:bottom-0 left-0 right-0 px-4 py-4 border-t z-40 bg-white" style={{ borderColor: '#E5E7EB' }}>
