...
export default function JogakPage() {
  ...
  const seedPosts: JogakPost[] = [
    ...
    { id: 'seed-14', authorId: null, title: '강남 고구려 다음주 토요 대규모', author: '고구려VIP', date: '2026-04-18', comments: 15, region: '강남', jogakType: '테이블', venue: '고구려', meetDate: '2026-04-26', meetTime: '22:00', maxPeople: 10, currentPeople: 4, genderPref: '남녀 혼성', ageRange: '25~35세', costSplit: '모든비용 엔빵', tableCost: '테이블비 120만', perPerson: '약 12만원', contactMethod: '놀쿨 쪽지', photoExchange: '사진교환 필수', message: '고구려 대규모 조각 모집합니다. 남녀 5:5 맞출 거고 분위기 확실히 보장합니다.', jogakCategory: 'partner' },
