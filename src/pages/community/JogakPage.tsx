...
export default function JogakPage() {
  ...
  const samplePosts: Post[] = [
    ...
    { id: 's5', user_id: null, category: 'party', title: '일산 금요일 저녁 2차 합류할 분', content: '회식 끝나고 일산룸 가는데 다른 분들도 합류 환영! 신실장님한테 미리 얘기해놨어요. 8시쯤 도착 예정.', venue_slug: 'ilsanroom', likes: 6, views: 45, is_pinned: false, created_at: '2026-03-28T12:00:00Z', updated_at: '2026-03-28T12:00:00Z', users: { nickname: '일산직장인', avatar_url: null }, comment_count: 2 },
  ];
