...
export default function LoungePage() {
  ...
  const richDescByType: Record<string, string> = {
    night: '강남 부산 수원 일산 나이트 다녀온 사람들의 실시간 이야기. 부킹 성공기, 부스 시세, 매니저 평판, 양주 라인업 비교까지. 솔직 후기와 질문이 오가는 나이트 전용 게시판.',
    club: '강남 홍대 이태원 일산 클럽 음악·DJ·분위기·게스트 라인업 추천 정보. EDM 힙합 테크노 장르별 추천, 입장 줄 짧은 시간대, 친구와 가는 코스 등 클럽 다니는 사람들의 전용 게시판.',
    room: '일산 강남 수원 부산 룸 이용 후기와 추천 정보. 4인 소형부터 30인 단체석까지 인원별 시세, 발렌타인 조니워커 양주 라인업, 매니저 평판, 예약 팁 공유.',
    yojung: '전통 요정 방문 경험과 정보 공유. 정찬 15첩 코스, 국악 라이브, 비즈니스 만찬 후기. 일산명월관·종로요정·강남요정 등 가격대 15~25만원 코스, 드레스코드, 예약 매너까지.',
    hoppa: '여성 전용 사교 공간 호빠 방문 후기·추천. 강남 종로 영등포 시세, 매니저 평판, 첫방문 동선, 안전 정보까지. 여자 혼자 가도 안전한 호빠 정보 나누는 전용 게시판.',
    lounge: '강남 홍대 이태원 일산 라운지바 분위기·칵테일·위스키 추천 게시판. 데이트 코스, 접대용 라운지, 야경 좋은 루프탑·호텔 라운지 후기. 1인 3~15만원 예산별 추천 공유.',
    free: '업종 상관없이 자유롭게 대화하는 라운지 공간. 잡담, 질문, 황당썰, 후기, 추천, 푸념까지 익명으로 OK. 매일 새 글 200개 이상 올라오는 밤문화 회원들의 광장.',
    qna: '밤문화 관련 궁금한 거 다 답해주는 Q&A 게시판. 첫방문 매너, 가격대 비교, 업소 추천, 안전 팁, 드레스코드까지. 단골 회원들이 빠르게 답변해주는 실시간 질문방.',
  };
  useDocumentMeta(
