...
const sections = [
  {
    ...
    title: "기본 규칙",
    items: [
      "다른 회원을 존중하고 예의 바르게 소통합니다.",
      "건전한 토론 문화를 지향합니다. 의견이 다르더라도 상대방을 비하하지 않습니다.",
      "본인의 실제 경험에 기반한 세부내용를 공유합니다.",
      "게시판의 목적에 맞는 주제로 글을 작성합니다.",
      "동일하거나 유사한 내용을 반복 게시하지 않습니다.",
      "타인의 게시글이나 댓글을 무단으로 복제하지 않습니다.",
    ],
  },
  {
    id: "prohibited",
    ...
    title: "금지 콘텐츠",
    items: [
      "허위 후기: 방문하지 않은 장소에 대한 거짓 리뷰, 경쟁 장소를 폄하하기 위한 악성 평가는 즉시 삭제됩니다.",
      "스팸 및 광고: 장소 홍보, 상업적 광고, 외부 링크 스팸은 허용되지 않습니다. 업주분은 공식 채널을 활용해 주세요.",
      "성적/음란 콘텐츠: 선정적이거나 음란한 텍스트, 이미지, 링크는 즉시 삭제되며 계정이 정지될 수 있습니다.",
      "폭력 및 위협: 타인에 대한 폭력, 위협, 괴롭힘은 어떤 형태로든 금지됩니다.",
      "개인세부내용 노출: 타인의 실명, 연락처, 주소, 사진 등 개인세부내용를 동의 없이 게시하는 것은 금지됩니다.",
  ...
  },
  {
    ...
    title: "리뷰 작성 가이드",
    items: [
      "솔직한 경험을 바탕으로 작성합니다. 과장이나 축소 없이 실제 경험을 공유하면 다른 회원들에게 큰 도움이 됩니다.",
      "구체적인 세부내용를 포함합니다. 방문 시간대, 분위기, 서비스 수준, 음료 퀄리티 등 구체적인 세부내용가 좋은 후기를 만듭니다.",
      "사진 첨부를 권장합니다. 실제 현장 사진이 있으면 리뷰 신뢰도가 올라가고, 추가 XP도 받아요.",
      "별점은 공정하게 매깁니다. 1점과 5점만 남기기보다 실제 경험에 맞는 별점을 부여합니다.",
      "장소 관계자의 대리 후기는 금지됩니다. 적발 시 해당 평가 삭제 및 계정 정지 조치가 이루어집니다.",
      "후기 수정은 자유롭게 가능하지만, 삭제 후 재작성은 월 1회로 제한됩니다.",
    ],
  },
  {
    id: "report-process",
    ...
    steps: [
      {
        step: "1단계: 신고 접수",
        description: "게시글이나 댓글의 '신고' 버튼을 거쳐 사유를 선택하고 제출합니다. 모든 신고는 익명으로 처리됩니다.",
      },
      {
        step: "2단계: 관리자 검토",
      ...
      {
        step: "3단계: 조치",
        description: "검토 결과에 따라 경고, 콘텐츠 삭제, 일시 정지(7일/30일), 내지 영구 정지 조치가 이루어집니다.",
      },
      {
        step: "이의 제기",
        description: "조치에 이의가 있는 경우, 고객센터를 거쳐 소명하시면 됩니다. 조치일로부터 7일 안에 신청해 주세요.",
      },
    ],
  },
  {
...
export default function GuidelinesPage() {
  useDocumentMeta('이것만 지키면 된다, 커뮤니티 규칙', '딱 1가지만 알면 끝, 우리 동네 매너. 광고·욕설·도배·암시 표현은 즉시 차단. 익명 보장하되 기본 매너만 지키면 자유. 신고·블락 1번 누르면 바로 처리.');
  return (
        ...
        <div className="space-y-8">
          ...
          <section className="rounded-2xl border border-neon-border bg-neon-surface p-6">
            ...
            <p className="mb-6 text-sm text-neon-text-muted">
              활동을 거쳐 XP를 획득하고, 레벨을 올려보세요. 레벨이 올라갈수록 쏠쏠한 혜택이 따라와요.
            </p>
