...
const disclaimerSections = [
  {
    ...
    title: "내역의 정확성",
    content:
      '플밤(이하 "플랫폼")에 게시된 모든 매장 내역(영업시간, 위치, 가격, 당사사이트 내용 등)는 참고용으로만 게재됩니다. 관계된 내역는 입점처 측의 수정, 시기적 차이, 기타 사유로 인해 실제와 다를 수 있습니다. 본 사이트는 내역의 정확성, 완전성, 최신성을 보증하지 못합니다.',
  },
  {
    icon: "🏢",
    title: "점포 관리운용에 대한 책임",
    content:
      "플랫폼에 등록된 장소의 관리운용, 게재 품질, 안전, 위생 등에 대한 책임은 전적으로 해당 매장에 있습니다. 본 서비스는 점포의 관리운용 행위에 대해 어떠한 책임도 지지 않으며, 장소 이용으로 인해 발생하는 손해에 대해 배상 의책가 없습니다.",
  },
  {
    icon: "💬",
    title: "이용자 생성 자료",
    content:
      "평가글, 댓글, 게시글 등 방문자가 작성한 자료는 해당 이용자 개인의 의견이며, 플밤의 공식 입장을 대변하지 않습니다. 방문자 생성 콘텐츠의 진위 여부에 대해 본 플랫폼은 보증하지 않습니다.",
  },
  {
    icon: "🔗",
    title: "외부 링크",
    content:
      "본 시스템 내에서 게재되는 외부 웹사이트 링크는 이용자의 편의를 위해 게재됩니다. 본 서비스는 외부 웹사이트의 콘텐츠, 개인내역 보호 정책, 보안에 대해 책임을 지지 않습니다.",
  },
  {
    icon: "⚖️",
    title: "법적 준수",
  ...
  },
  {
    ...
    title: "시스템 가용성",
    content:
      "본 서비스는 안정적이고 지속적인 관리운용을 위해 노력하지만, 기술적 오류, 서버 장애, 유지보수 등의 사유로 플랫폼이 일시적으로 중단될 수 있습니다. 이로 인한 손해에 대해 본 시스템은 책임을 지지 않습니다.",
  },
  {
    icon: "💰",
    title: "금전적 거래",
    content:
      "플랫폼을 매개로 이루어지는 입점처와 방문자 간의 금전적 거래(입장료, 예약비 등)에 대해 본 서비스는 중개자 역할만 수행하며, 거래 당사자 간의 갈등에 대해 책임을 지지 않습니다. 결제 관계된 문제는 해당 매장 또는 결제 대행사에게 직접 문의하시기 바랍니다.",
  },
  {
    icon: "🔄",
    title: "면책조항의 수정",
...
export default function DisclaimerPage() {
  useDocumentMeta('면책조항 | 플밤', '이 사이트 내용은 참고용. 법적 효력이나 보증은 없다.');
  return (
      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="mt-12 rounded-2xl border border-violet-500/20 bg-neon-primary-light/5 p-6 md:p-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm leading-relaxed text-neon-text">
            본 서비스는 매장 내역를 모아서 보여주는 내역 플랫폼입니다. 해당 장소의 실제
