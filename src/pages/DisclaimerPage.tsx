...
const disclaimerSections = [
  {
    ...
    title: "내역의 정확성",
    content:
      '놀쿨(이하 "플랫폼")에 게시된 모든 매장 내역(영업시간, 위치, 가격, 당사사이트 내용 등)는 참고용으로만 게재됩니다. 관계된 내역는 입점처 측의 수정, 시기적 차이, 기타 사유로 인해 실제와 다를 수 있습니다. 본 사이트는 내역의 정확성, 완전성, 최신성을 보증하지 못합니다.',
  },
  {
    icon: "🏢",
  ...
  },
  {
    ...
    title: "이용자 생성 자료",
    content:
      "평가글, 댓글, 게시글 등 방문자가 작성한 자료는 해당 이용자 개인의 의견이며, 놀쿨의 공식 입장을 대변하지 않습니다. 방문자 생성 콘텐츠의 진위 여부에 대해 본 플랫폼은 보증하지 않습니다.",
  },
  {
    icon: "🔗",
    title: "외부 링크",
