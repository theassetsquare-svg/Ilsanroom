  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 space-y-12">
      ...
      <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6 space-y-4">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            룸 크기는 4인 소형부터 30인 넘는 대형까지 선택 폭이 넓다. 룸에서 생일파티, 비즈니스 모임, 단체 모임, 기업 워크숍 뒤풀이까지 인원에 맞게 고르면 된다. 일산은 일산룸 총책임자이 전화 한 통이면 인원수에 맞는 자리를 바로 잡아준다. 해운대 마린시티에는 개별 공간이 60개 넘는 대형 시설도 있다.
          </p>
          <p className="text-base leading-relaxed text-neon-text-muted">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            일산룸은 일산룸 총책임자(010-4117-5556)이 예약과 당일 안내를 맡는다. 마두역 1번출구 도보 3분 거리에 있고, 방음이 확실해서 비즈니스 미팅부터 생일파티까지 다 된다. VIP룸은 별도 분리되어 있어서 중요한 손님 모실 때 제격이다. 해운대고구려는 부산 마린시티에 위치한 대형 시설로, 룸이 60개가 넘는다. 2인용부터 20인 넘는 대형방까지 골라서 쓸 수 있고, 정찰제로 운영된다.
          </p>
