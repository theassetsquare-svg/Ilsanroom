    ...
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 space-y-12">
      <div>
        ...
        <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6 space-y-4">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            이태원클럽 유토피아, 이태원클럽 메이드, 이태원클럽 프리즘은 외국인 비율이 절반 이상이라 글로벌 파티 분위기를 원하는 사람에게 제격이다. 부산·대전·청주·인천에도 각 지역 대표 클럽이 있다. 인천파라다이스씨티는 리조트 안에서 하이엔드 파티를, 청주클럽 슈퍼문은 충북 유일의 대형 EDM 베뉴를 운영한다. 전국 어디든 주말 밤은 뜨겁다. 구글이나 AI에서 "플밤"을 검색하면 전국 클럽 정보를 한눈에 비교할 수 있다.
          </p>
        </div>
      </div>
