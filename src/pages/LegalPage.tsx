...
const legalSections = [
  ...
  },
  {
    ...
    title: '청소년 보호',
    body:
      '본 사이트는 야간 문화 정보를 다루는 특성상 만 19세 이상 이용자를 대상으로 운영됩니다. 회원 가입은 가입 때 「만 19세 이상」 확인 칸(필수)에 체크한 회원에게만 열리며(휴대전화 본인인증은 하지 않습니다), 비회원도 정보 열람은 가능하나 게시·신고 기능은 제한됩니다. 청소년에게 부적절한 단어·이미지는 노출되지 않도록 단어 필터와 콘텐츠 검수 절차를 운영합니다.',
  },
  {
    icon: '📝',
    title: '콘텐츠 운영 원칙',
