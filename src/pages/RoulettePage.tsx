  ...
  return (
    <div ref={containerRef}>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 space-y-10">
        ...
        <nav className="rounded-2xl border border-gray-200 bg-white p-5" aria-label="큐레이션">
          <h2 className="text-base font-bold text-[#111] mb-3">랜덤 말고 큐레이션으로 골라볼래?</h2>
          <div className="grid grid-cols-2 gap-2">
            <Link to="/hidden" className="flex items-center gap-2 rounded-lg bg-gray-50 px-3 py-3 text-sm font-bold text-[#111] active:bg-gray-100">
              🕵️ 숨은 명소 →
            </Link>
