...
const articles = [
  ...
  },
  {
    ...
    title: "회원가입 및 계정",
    items: [
      "회원가입은 만 19세 이상인 사람이 가입 화면에서 「만 19세 이상 확인」·이용약관·개인정보 수집·이용(필수 3개)에 동의하고 카카오·구글 계정 또는 이메일로 신청하여 이루어집니다.",
      "서비스 알림과 광고성 정보 수신은 선택이며, 동의하지 않아도 가입과 이용에 제한이 없습니다. 알림은 찜 목록 쪽의 알림 설정에서 언제든 한 번에 끌 수 있습니다.",
      "플랫폼은 타인의 계정을 도용하였거나 만 19세 미만임이 확인된 신청은 거부하거나 해지할 수 있습니다.",
