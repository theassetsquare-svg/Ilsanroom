...
const articles = [
  {
    ...
    title: "취지",
    content:
      '이 약관은 본사(이하 "회사")이 공급하는 밤문화 데이터 서비스(이하 "서비스")의 이용과 연관하여 회사와 사용자 간의 권리, 책무 및 책임항목, 기타 필요한 항목을 규정함을 취지으로 시행합니다.',
  },
  {
    number: "제2조",
    title: "정의",
    items: [
      '"서비스"란 회사가 공급하는 밤문화 입점업체 데이터, 감상문, 커뮤니티 등 연관 제반 서비스를 의미시행합니다.',
  ...
  },
  {
    ...
    title: "웹사이트 기능 공급",
    items: [
      "당사는 다음의 기능을 공급시행합니다: 밤문화 입점업체 데이터 공급, 회원 감상문 및 평가 기능, 커뮤니티 게시판 진행, 기타 진행사가 정하는 기능.",
...
export default function TermsPage() {
  useDocumentMeta('이용약관 | 놀쿨', '회원가입부터 탈퇴까지 권리와 의무 정리.');
  return (
