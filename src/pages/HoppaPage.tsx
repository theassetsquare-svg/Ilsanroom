...
export default function HoppaPage() {
  useDocumentMeta('혼자 가도 돼요? 오히려 1인 손님이 더 많다 | 플밤', '여성 전용 사교 공간 18곳. 가격 투명, 안전 확인 완료. 사전 전화 한 통이면 준비 끝.');
