...
const sections = [
  {
    ...
    title: "총칙",
    items: [
      '본 규정은 놀쿨(이하 "플랫폼")에 점포 상세사항를 게시하고자 하는 사업자(이하 "게시 업소")와 플랫폼 간의 권리, 소임 및 책임사항을 규정합니다.',
    ...
    subsections: [
      {
        ...
        items: [
          ...
          "프리미엄 신청: 월 정액제 (놀쿨 내 우선 노출, 프로모션 배너, 상세 통계 포함)",
  ...
  },
  {
    ...
    title: "매장 상세사항 관리 소임",
    items: [
      "접수 영업장은 영업시간, 가격, 운영 내용 등 상세사항에 갱신이 있을 경우 24시간 이내에 수정해야 합니다.",
  ...
  },
  {
    ...
    items: [
      ...
      "다음 사유에 해당하는 경우 플랫폼은 사전 통보 후 기재를 해지합니다: 규정 불준수, 허위 상세사항 반복 기재, 관련 법적규범 불준수, 가맹점 민원 누적.",
  ...
  },
  {
    ...
    items: [
      ...
      "게시 해지 후에도 이미 공개된 상세사항(이용자 리뷰 포함)는 사이트에 남아 있을 수 있어요.",
    ],
  },
  {
    number: 10,
...
export default function VenueTermsPage() {
  useDocumentMeta('업소등록약관 | 놀쿨', '광고 게재 조건, 환불 규정, 콘텐츠 삭제 기준 안내.');
  return (
      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="mb-10 rounded-2xl border border-violet-500/20 bg-neon-primary-light/5 p-6 md:p-8">
          ...
          <p className="mb-4 text-sm leading-relaxed text-neon-text">
            놀쿨에 매장을 입점하고 더 많은 고객에게 다가가세요. 기본 게시는
