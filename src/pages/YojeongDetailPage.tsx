...
const myeongwolgwanFaqs = [
  ...
  { question: '비즈니스 접대에 적합한가요?', answer: '격조 있는 분위기, 정찬 코스, 국악 공연이 어우러져 VIP 접대 자리로 잘 맞습니다. 거래처 만찬, 외국인 대접 자리에 자주 이용되며, 신실장에게 사전 예약 시 맞춤 서비스를 받을 수 있습니다.' },
  { question: '예약은 어떻게 하나요?', answer: '신실장에게 전화하여 예약하세요. 인원, 일시, 코스를 미리 알려주시면 알맞은 룸과 메뉴를 안내받을 수 있습니다.' },
