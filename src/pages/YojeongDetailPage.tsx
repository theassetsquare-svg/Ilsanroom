...
const myeongwolgwanFaqs = [
  ...
  { question: '비즈니스 접대에 적합한가요?', answer: '격조 있는 분위기, 정찬 코스, 국악 공연이 어우러져 VIP 접대 자리로 잘 맞습니다. 거래처 만찬, 외국인 대접 자리에 자주 이용되며, 일산룸 총책임자에게 사전 예약 시 맞춤 서비스를 받을 수 있습니다.' },
  { question: '예약은 어떻게 하나요?', answer: '일산룸 총책임자에게 전화하여 예약하세요. 인원, 일시, 코스를 미리 알려주시면 알맞은 룸과 메뉴를 안내받을 수 있습니다.' },
  ...
  { question: '명월관의 영업시간은?', answer: '기본정보 탭에서 확인하거나 일산룸 총책임자에게 문의해 주세요. 저녁 6시~10시가 가장 추천하는 방문 시간대입니다.' },
];
  ...
  return (
    <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-8 space-y-6">
      ...
      <div className="space-y-4 text-sm leading-relaxed text-neon-text-muted">
        ...
        <p>
          일산룸 총책임자이 전반적인 운영을 총괄하고 있으며,
          사전 예약 시 인원, 목적, 예산에 맞춰 알맞은 코스와 룸을 추천받을 수 있습니다.
          마두역에서 도보 약 10분 거리에 위치하며,
          건물 내 전용 주차장과 발렛 서비스까지 갖추고 있어 차 끌고 와도 걱정 없습니다.
        </p>
        <p>
          고양시에서 격식 있는 접대 자리가 필요하거나 중요한 손님을 모실 자리를 준비 중이라면
          여기를 한번 떠올려보세요. 거래처 만찬, VIP 접대, 외국인 대접 등
