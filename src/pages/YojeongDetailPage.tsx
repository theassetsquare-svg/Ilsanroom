...
const defaultFaqs = (name: string) => [
  ...
  { question: `복장 규정과 전반적인 분위기는 어떤가요?`, answer: `남성은 정장 또는 셔츠에 슬랙스, 여성은 단정한 원피스나 한복이 어울리는 격식 있는 공간입니다. 차분하고 고급스러운 분위기가 특징이며, 큰 소리나 과한 행동은 자제하는 것이 매너입니다.` },
  ...
  { question: `단체 행사는 몇 명까지 수용 가능한가요?`, answer: `소규모 룸(4~8인)부터 대연회장(30~50인)까지 크고 작은 룸이 골고루 갖춰진 곳이 많습니다. 돌잔치·환갑·칠순·상견례 등 가족 행사와 기업 연회 모두 수용 가능하며, 대규모 행사는 1~2주 전 예약이 필수입니다.` },
];
...
const myeongwolgwanFaqs = [
  ...
  { question: '비즈니스 접대에 적합한가요?', answer: '격조 있는 분위기, 정찬 코스, 국악 공연이 어우러져 VIP 접대에 최적입니다. 신실장에게 사전 예약 시 맞춤 서비스를 받을 수 있습니다.' },
  ...
  { question: '가족 모임에도 이용 가능한가요?', answer: '돌잔치, 환갑, 칠순, 상견례 등 가족 기념일에도 많이 이용됩니다. 프라이빗 룸 환경에서 격식 있는 모임을 치르기 딱 좋습니다.' },
  ...
  return (
    <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-8 space-y-6">
      ...
      <div className="space-y-4 text-sm leading-relaxed text-neon-text-muted">
        ...
        <p>
          고양시에서 격식 있는 접대 장소를 찾거나, 잊지 못할 가족 모임을 계획하고 계신다면
