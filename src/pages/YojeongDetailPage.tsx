...
const defaultFaqs = (name: string) => [
  ...
  { question: `단체 행사는 몇 명까지 수용 가능한가요?`, answer: `소규모 룸(4~8인)부터 대연회장(30~50인)까지 크고 작은 룸이 골고루 갖춰진 곳이 많습니다. 돌잔치·환갑·칠순·상견례 등 기념행사와 기업 연회 모두 수용 가능하며, 대규모 행사는 1~2주 전 예약이 필수입니다.` },
];
...
const myeongwolgwanFaqs = [
  ...
  { question: '이용 가격대는?', answer: '정찰제로 투명한 가격 정책을 유지합니다. 가격표 탭에서 대략적인 가격대를 살펴봐. 코스별 상세 가격은 전화 문의로 안내받으실 수 있습니다.' },
  { question: '주차 및 발렛 서비스가 가능한가요?', answer: '건물 내 전용 주차장을 보유하고 있으며, 발렛 주차 서비스도 이용 가능합니다.' },
  { question: '특별한 자리에도 이용 가능한가요?', answer: '돌잔치, 환갑, 칠순, 상견례 등 가족 기념일에도 많이 이용됩니다. 프라이빗 룸 환경에서 격식 있는 모임을 치르기 딱 좋습니다.' },
  ...
  return (
    <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-8 space-y-6">
      ...
      <div className="space-y-4 text-sm leading-relaxed text-neon-text-muted">
        ...
        <p>
          고양시에서 격식 있는 접대 장소를 찾거나, 잊지 못할 특별한 자리을 계획하고 계신다면
