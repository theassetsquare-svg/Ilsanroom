...
const defaultFaqs = (name: string) => [
  ...
  { question: `코스 요리 메뉴는 어떻게 구성되나요?`, answer: `전채·구절판·생선회·갈비찜·전골·후식 등 10~15가지 이상의 정찬 코스가 제공됩니다. 계절별로 식재료가 달라지며, 인원과 예산에 따라 코스 등급을 선택할 수 있습니다.` },
  ...
  { question: `단체 행사는 몇 명까지 수용 가능한가요?`, answer: `소규모 룸(4~8인)부터 대연회장(30~50인)까지 다양한 규모를 갖춘 곳이 많습니다. 돌잔치·환갑·칠순·상견례 등 가족 행사와 기업 연회 모두 수용 가능하며, 대규모 행사는 1~2주 전 예약이 필수입니다.` },
];
