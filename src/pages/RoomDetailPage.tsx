...
const defaultFaqs = (name: string) => [
  { question: `${name}의 최소·최대 인원 구성은 어떻게 되나요?`, answer: `룸 종류에 따라 최소 2인부터 최대 30인 이상까지 수용 가능합니다. 소규모 룸(2~6인), 중형 룸(7~15인), 대형 룸(16인 이상)으로 나뉘며, 인원에 맞는 공간을 배정받을 수 있습니다.` },
  ...
  { question: `룸 크기와 시설 차이가 궁금해요`, answer: `기본 룸에는 소파·테이블·노래방 기기가 갖춰져 있고, VIP 룸은 넓은 공간에 전용 화장실·대형 TV·고급 음향 시스템이 추가됩니다. 업소에 따라 다트·보드게임 등 부대시설이 있는 특별 룸도 운영합니다.` },
  { question: `음식 반입이나 별도 주문이 가능한가요?`, answer: `외부 음식 반입은 대부분 불가능하며, 룸 내에서 자체 메뉴(안주·과일·디저트)를 주문할 수 있습니다. 케이크 등 기념일 용품은 사전 협의 시 반입을 허용하는 곳이 많으니 미리 문의하세요.` },
  { question: `비즈니스 접대 시 추천 코스가 있나요?`, answer: `VIP 룸을 예약하고 프리미엄 양주 세트와 고급 안주 코스를 주문하는 것이 일반적입니다. 담당 매니저에게 접대 목적임을 알리면 서비스 수준과 룸 분위기를 한 단계 높여 준비해 줍니다.` },
  { question: `시간 연장은 어떻게 하고 추가 비용은?`, answer: `기본 이용 시간은 보통 2~3시간이며, 연장은 30분 또는 1시간 단위로 가능합니다. 연장 요금은 기본 시간당 금액의 50~100% 수준이며, 피크 타임에는 대기 손님이 있어 연장이 제한될 수 있습니다.` },
  ...
  { question: `취소·환불 정책은 어떻게 되나요?`, answer: `대부분 방문 당일 2~3시간 전까지 무료 취소가 가능하며, 노쇼(No-show) 시 예약금 환불이 불가한 곳이 많습니다. 정확한 취소 규정은 예약 시 담당자에게 반드시 확인하세요.` },
];
