...
const caseStudies = [
  {
    ...
    solution: '밤키에 프리미엄 등록을 진행하고 "일산요정", "일산명월관" 등 핵심 검색어에서 상세 페이지가 노출되도록 구성했습니다. 한정식 코스 안내와 자주 묻는 질문까지 넣어서 방문 전 궁금증을 미리 풀어줬습니다.',
  ...
  },
  {
    ...
    result: '"수원찬스돔나이트" 검색 시 밤키 상세 페이지가 상위에 노출되기 시작했고, 주말 방문객이 유의미하게 증가했습니다.',
    metric: '검색 상위',
  ...
  },
  {
    ...
    result: '밤키를 통해 브랜드 인지도가 강화되었으며, 처음 방문하는 고객의 테이블 사전 문의 비율이 크게 늘었습니다.',
    metric: '+180%',
...
export default function CaseStudiesPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      ...
      <p className="text-sm text-neon-text-muted mb-8">밤키 입점 후 달라진 업주들의 이야기</p>
