...
const caseStudies = [
  {
    ...
    solution: '플밤에 프리미엄 등록을 진행하고 "일산요정", "일산명월관" 등 핵심 검색어에서 상세 페이지가 노출되도록 구성했습니다. 한정식 코스 안내와 자주 묻는 질문까지 넣어서 방문 전 궁금증을 미리 풀어줬습니다.',
  ...
  {
    id: 'cs2',
    title: '수원찬스돔나이트 — 플밤 내 우선 노출로 주말 방문자 확대',
    venue: '수원찬스돔나이트',
    region: '수원',
    category: '나이트',
    challenge: '수원 지역에 여러 유흥 업소가 있지만, 온라인에서 우리 가게만의 색깔을 보여줄 채널이 없었습니다.',
    solution: '돔 형태 인테리어, 최신 사운드 시스템 등 고유 특징을 부각한 단독 상세 페이지를 구성했습니다. 365일 운영이라는 장점을 전면에 배치하고, 담당자 연결 기능을 추가했습니다.',
    result: '"수원찬스돔나이트" 검색 시 플밤 상세 페이지가 상위에 노출되기 시작했고, 주말 방문객이 유의미하게 증가했습니다.',
    metric: '검색 상위',
    metricLabel: '수원 나이트 키워드',
  },
  {
    id: 'cs3',
    title: '강남청담클럽 레이스 — 독립 SEO 페이지로 테이블 예약 증가',
    venue: '강남청담클럽 레이스',
    region: '강남',
    category: '클럽',
    challenge: '강남 클럽 시장은 경쟁이 치열하여, 온라인에서 브랜드를 차별화하고 신규 고객에게 정보를 전달하는 것이 과제였습니다.',
    solution: '"강남청담클럽 레이스"를 독립 검색어로 최적화한 상세 페이지를 구성하고, EDM 파티홀로서의 정체성을 명확히 전달하는 콘텐츠를 제작했습니다.',
    result: '플밤를 통해 브랜드 인지도가 강화되었으며, 처음 방문하는 고객의 테이블 사전 문의 비율이 크게 늘었습니다.',
    metric: '+180%',
...
export default function CaseStudiesPage() {
  useDocumentMeta('매출이 올라간 실제 사례 | 플밤', '수원찬스돔, 강남청담클럽이 겪은 매출 변화. 그래프가 증명한다.');
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      <h1 className="text-2xl font-extrabold text-neon-text mb-1">입점 사례 연구</h1>
      <p className="text-sm text-neon-text-muted mb-8">플밤 입점 후 달라진 업주들의 이야기</p>
