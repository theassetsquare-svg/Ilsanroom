  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 space-y-12">
      ...
      <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6 space-y-4">
          ...
          <h3 className="text-base font-bold text-neon-text pt-1">오늘 라운지 어디부터 잡을까?</h3>
          <p className="text-base leading-relaxed text-neon-text-muted">
            목적부터 정하면 빠르다. 1차 식사 뒤 조용히 한 잔 더 하며 대화를 이어가고 싶으면 식후주 중심의 위스키·아마로 라인이 강한 라운지, 분위기 자체를 즐기며 새로운 향을 맛보고 싶으면 바텐더가 취향을 묻고 즉석 조제해주는 칵테일 중심 라운지가 맞다. 소개팅이라면 맞은편 얼굴이 잘 보이고 목소리가 묻히지 않는 자리를, 접대라면 프라이빗 부스가 있는 라운지를 먼저 본다. 인원도 변수다 — 1인이나 둘이면 바 카운터에서 시작하는 게 자연스럽고, 셋 이상이면 부스를 미리 연락해 잡아두는 편이 안전하다. 매장별 시그니처와 운영은 라운지마다 다르니 끌리는 곳의 상세에서 한 번 더 확인하면 된다.
          </p>
