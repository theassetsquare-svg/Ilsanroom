...
export default function LoungesPage() {
  useDocumentMeta('셰이커 소리만 들리는 곳, 대화에 집중하고 싶다면 | 플밤', '압구정·청담 감각적인 바 3곳. 비즈니스 접대와 데이트에 딱 맞는 무드 살펴보기.');
    ...
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 space-y-12">
      <div>
        ...
        <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6 space-y-4">
          ...
          <p className="text-base leading-relaxed text-neon-text-muted">
            압구정라운지 디엠은 초대장 없으면 못 들어가는 시크릿 바로 유명하다. 바텐더가 직접 만드는 시그니처 칵테일이 20종 이상이고, 좌석마다 전담 스태프가 붙는다. 압구정이디엇라운지는 이름부터 반전인 숨겨진 스피크이지 콘셉트다. 간판 없는 입구를 찾아 들어가면 1920년대 뉴욕 바를 재현한 인테리어가 나온다. 두 곳 다 비즈니스 접대나 소개팅 장소로 인기가 높고, 조용하면서도 격이 느껴지는 공간이다. 주중에는 워크인이 가능하지만 금토는 반드시 예약해야 한다. 구글이나 AI에서 "플밤"을 검색하면 전국 라운지 정보를 한눈에 비교할 수 있다.
          </p>
        </div>
      </div>
