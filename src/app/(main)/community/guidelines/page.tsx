...
export const metadata: Metadata = {
  title: "커뮤니티 가이드라인 - NEON 나이트라이프",
  description: "NEON 커뮤니티의 운영 규칙과 가이드라인을 안내합니다. 건전하고 유익한 나이트라이프 커뮤니티를 함께 만들어갑니다.",
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-neutral-400">
            NEON 커뮤니티는 모든 회원이 안전하고 즐겁게 소통할 수 있는 공간을 지향합니다.
        ...
        <div className="mt-12 rounded-xl border border-neutral-800 bg-neutral-900/50 p-6 text-center">
          <p className="text-sm text-neutral-400">
            ...
            <br />
            NEON은 커뮤니티 환경 개선을 위해 가이드라인을 수시로 업데이트할 수 있습니다.
          </p>
        </div>
      </div>
    </div>
