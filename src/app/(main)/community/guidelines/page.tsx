...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "구체적인 정보를 포함합니다. 방문 시간대, 분위기, 서비스 수준, 음료 퀄리티 등 구체적인 정보가 좋은 리뷰를 만듭니다.",
    ...
    <div className="min-h-screen bg-neon-bg text-neon-text">
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold">이용 규칙</h1>
        ...
        <div className="space-y-8">
          ...
          <section className="rounded-2xl border border-neon-border bg-neon-surface p-6">
            ...
            <p className="mb-6 text-sm text-neon-text-muted">
              활동을 통해 XP를 획득하고, 레벨을 올려보세요. 높은 레벨일수록 특별한 혜택이 주어집니다.
            </p>
