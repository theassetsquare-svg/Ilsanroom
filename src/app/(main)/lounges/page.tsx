...
export default function LoungesPage() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 space-y-12">
      <div>
        ...
        <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6">
          <p className="text-base leading-relaxed text-neon-text-muted">
            고급스러운 인테리어와 조용한 분위기에서 칵테일, 와인, 위스키 등 프리미엄 주류를 즐기며
            ...
            커플 데이트 등 목적에 따라 분위기가 다른 곳을 선택할 수 있습니다.
            대부분 스마트 캐주얼 이상의 복장을 권장하며, 논현·청담 일대에는 프라이빗 부스가 있는 곳도 있으니
      ...
      <CategoryVSBattle venueA="압구정라운지 디엠" venueB="압구정이디엇라운지" topic="압구정 프리미엄 칵테일 바 대결" />
