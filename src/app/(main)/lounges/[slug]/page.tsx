...
const defaultFaqs = (name: string) => [
  ...
  { question: `${name}의 영업시간은?`, answer: `영업시간은 기본정보 탭에서 확인하세요. 방문 전 전화로 확인을 권장합니다.` },
  { question: `${name}의 드레스코드가 있나요?`, answer: `라운지는 보통 스마트 캐주얼 이상을 권장합니다.` },
  { question: `${name}에서 칵테일을 즐길 수 있나요?`, answer: `대부분의 라운지에서 다양한 칵테일과 주류를 제공합니다.` },
  { question: `${name}의 예약은 어떻게 하나요?`, answer: `전화를 통해 예약이 가능합니다. 하단 전화 버튼을 이용하세요.` },
  { question: `${name}의 가격대는?`, answer: `가격표 탭에서 확인할 수 있습니다.` },
  { question: `${name}에 단체 이용이 가능한가요?`, answer: `단체 이용 가능 여부는 업소에 직접 문의해 주세요.` },
