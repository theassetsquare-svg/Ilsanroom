...
const defaultFaqs = (name: string) => [
  { question: `${name}의 위치는 어디인가요?`, answer: `이 업소의 정확한 위치는 기본정보 탭에서 확인할 수 있습니다. 지도 탭에서 카카오맵으로도 확인 가능합니다.` },
  { question: `영업시간이 궁금해요`, answer: `영업시간은 기본정보 탭에서 확인하세요. 방문 전 전화로 확인하시는 것을 권장합니다.` },
  { question: `주차가 가능한가요?`, answer: `주차 가능 여부는 기본정보 탭에서 확인할 수 있습니다. 발렛 서비스 여부도 업소에 문의해 주세요.` },
  { question: `드레스코드가 있나요?`, answer: `각 업소마다 드레스코드가 다릅니다. 기본정보 탭에서 확인하거나 방문 전 전화 문의를 권장합니다.` },
  { question: `예약은 어떻게 하나요?`, answer: `전화 연결을 통해 예약이 가능합니다. 하단의 전화 버튼을 눌러 직접 문의해 주세요.` },
  { question: `가격대가 어느 정도인가요?`, answer: `가격표 탭에서 확인할 수 있습니다. 정확한 가격은 방문 시 변동될 수 있으므로 업소에 직접 확인하세요.` },
  { question: `단체 이용이 가능한가요?`, answer: `단체 이용 가능 여부와 수용 인원은 업소에 직접 문의해 주세요. 사전 예약을 권장합니다.` },
  { question: `분위기는 어떤가요?`, answer: `이 곳의 분위기와 특징은 기본정보 탭에서 확인할 수 있습니다. 실제 방문 후기도 리뷰 탭에서 확인하세요.` },
];
