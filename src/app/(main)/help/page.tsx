...
const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      {
        question: "일산룸포털은 어떤 서비스인가요?",
        answer:
          "일산룸포털은 나이트라이프 업소(룸, 라운지, 클럽, 요정 등)를 위한 올인원 디지털 플랫폼입니다. 업소 검색, 리뷰, 예약, 커뮤니티 기능을 제공하며, 업주에게는 노출 관리, 데이터 분석, 예약 시스템 등 비즈니스 도구를 제공합니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "프로 또는 그 이상의 플랜에 가입하면 자동으로 일산룸포털 인증 배지가 부여됩니다. 배지는 업소 프로필, 검색 결과, 카테고리 페이지에 표시되어 고객 신뢰도와 클릭률을 높여줍니다. 인증 업소는 평균 2.3배 높은 클릭률을 기록합니다.",
      },
    ],
  },
  {
