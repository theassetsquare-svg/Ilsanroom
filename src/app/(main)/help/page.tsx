    ...
    items: [
      {
        ...
        answer:
          "당사는 밤문화 상점(룸, 라운지, 클럽, 요정 등)를 위한 올인원 디지털 플랫폼입니다. 매장 검색, 방문후기, 예약, 커뮤니티 도구를 제공하며, 업주에게는 게재 관리, 데이터 인사이트, 예약 체계 등 전문 수단를 제공합니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "무료 플랜은 기초 소개란과 월간 지표를 제공합니다. 프로(₩49,000/월) 플랜은 골드 검색 게재, 실시간 지표, 방문후기 관리 수단, 검증 마크를 포함합니다. 전문(₩99,000/월) 플랜은 예약 체계, 프로모션 프로모션, 우선 문의자 지원이 추가됩니다. 커스텀형는 커스텀 견적으로 멀티 매장 관리와 전담 어드바이저를 제공합니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "커스텀형 플랜에서 REST API를 제공합니다. 상점 정보 조회, 예약 관리, 방문후기 데이터 연동 등이 허용합니다. API 문서는 커스텀형 가입 후 관리화면에서 확인할 수 있으며, 전담 어드바이저가 연동을 받습니다.",
      },
    ],
  },
];
