      ...
      <div>
        ...
        <div className="rounded-2xl border border-pink-200 bg-gradient-to-r from-pink-50 via-white to-rose-50 p-6 mb-6">
          ...
          <p className="text-base leading-relaxed text-pink-900/70">
            전문 호스트가 여성 고객에게 대화와 엔터테인먼트를 제공하는 여성 전용 공간이다.
            프라이빗한 분위기에서 편안하게 시간을 보낼 수 있고,
            강남·건대·장안동·수원·해운대·대전 등 전국 주요 도시에 위치해 있다.
            사전 전화 한 통이면 분위기, 가격, 이용 방법을 바로 안내받을 수 있어
            처음 가는 분도 걱정 없다.
            모든 업소는 구글·네이버 검색으로 현재 운영 확인 후 등록한 곳이다.
          </p>
        </div>
