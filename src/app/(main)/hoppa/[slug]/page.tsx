...
const defaultFaqs = (name: string) => [
  ...
  { question: `영업시간이 궁금해요`, answer: `영업시간은 기본정보 탭에서 확인하세요.` },
  { question: `드레스코드가 있나요?`, answer: `깔끔한 복장을 권장합니다.` },
  { question: `예약은 어떻게 하나요?`, answer: `전화로 예약 가능합니다. 하단 전화 버튼을 이용하세요.` },
  { question: `가격대가?`, answer: `가격표 탭에서 확인할 수 있습니다.` },
  { question: `${name}에 처음 가는데 어떻게 하나요?`, answer: `처음 방문하셔도 편안하게 즐기실 수 있습니다. 직원에게 안내를 요청하세요.` },
  { question: `단체 이용이 가능한가요?`, answer: `업소에 직접 문의해 주세요.` },
