...
export const metadata: Metadata = {
  title: '사례 연구 | 일산룸포털 - 업주 성공 스토리',
  description: '일산룸포털에 입점한 업주들의 매출 상승, 방문자 증가, 브랜드 인지도 향상 사례를 확인하세요.',
};
...
const caseStudies = [
  {
    ...
    solution: '일산룸포털에 프리미엄 등록 후, "일산요정", "일산명월관" 등 핵심 키워드에서 검색 상위 노출을 달성했습니다. 상세 정보 페이지, FAQ, 한정식 코스 안내를 통해 방문 전 정보 탐색이 용이해졌습니다.',
  ...
  },
  {
    ...
    solution: '일산룸포털에 업소 정보를 등록하고, 365일 운영이라는 차별점을 강조한 상세 페이지를 구성했습니다. 강호동 실장의 담당 정보와 전화 연결 기능이 포함되었습니다.',
    result: '"수원찬스돔나이트" 검색 시 일산룸포털 상세 페이지가 상위에 노출되며, 주말 방문객이 이전 대비 크게 증가했습니다.',
    metric: '검색 1위',
  ...
  },
  {
    ...
    solution: '일산룸포털에서 "강남클럽레이스"를 독립적인 SEO 키워드로 최적화하고, EDM 클럽으로서의 정체성을 명확히 하는 상세 페이지를 구성했습니다.',
    result: '일산룸포털을 통해 클럽레이스의 브랜드 인지도가 강화되었으며, 특히 처음 방문하는 고객의 테이블 사전 예약 비율이 증가했습니다.',
    metric: '+180%',
...
export default function CaseStudiesPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      ...
      <p className="text-neon-text-muted mb-10">일산룸포털 입점 업주들의 성공 스토리</p>
