...
export const metadata: Metadata = {
  title: "사례 연구 - 일산룸포털",
  description:
    "일산룸포털을 도입한 업소들의 성과를 확인하세요. 방문자 증가, 리뷰 개선, 매출 성장 사례.",
};
...
const caseStudies = [
  {
    ...
    summary:
      "일산명월관요정은 일산룸포털 프리미엄 등록 후 온라인 검색 노출이 대폭 증가했습니다. 특히 '일산요정', '일산명월관' 키워드에서 상위 노출을 달성하며, 40~60대 비즈니스 고객층의 예약 문의가 크게 늘었습니다. 리뷰 관리 기능을 적극 활용하여 사장님 답변을 달기 시작한 이후 재방문율이 눈에 띄게 향상되었습니다.",
    quote:
      "전통 요정이라는 특수한 업종에서 디지털 마케팅 효과를 실감했습니다. 일산룸포털 덕분에 예약이 5배 이상 늘었습니다.",
    quoteName: "이** 대표",
    metrics: [
      {
        label: "예약 증가율",
  ...
  },
  {
    ...
    summary:
      "일산룸은 일산룸포털 프로 플랜 도입 후 '일산룸' 키워드에서 1위를 유지하고 있습니다. 실시간 통계 대시보드를 통해 어떤 시간대에 방문자가 집중되는지 파악하고, 그에 맞춘 프로모션을 진행하여 비수기 매출까지 안정적으로 관리하고 있습니다. QR코드 프린트 기능으로 오프라인 명함에도 활용 중입니다.",
    quote:
  ...
  },
  {
    ...
    summary:
      "아시아 대표 메가 클럽 옥타곤은 일산룸포털 엔터프라이즈 플랜을 통해 API 연동까지 완료했습니다. 실시간 이벤트 업데이트, DJ 스케줄 자동 동기화, VIP 예약 시스템 연계 등 운영 효율이 크게 개선되었습니다. 일산룸포털을 통한 예약 전환율이 기존 채널 대비 3.2배 높게 나타났습니다.",
    quote:
      "대형 클럽도 결국 디지털 플랫폼이 핵심입니다. 일산룸포털의 분석 도구 덕분에 마케팅 ROI를 정확히 측정할 수 있게 되었습니다.",
    quoteName: "박** 매니저",
    metrics: [
      {
        label: "예약 전환율",
      ...
      <div className="mx-auto max-w-5xl px-4 py-16">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-lg text-lg text-neutral-400">
            일산룸포털과 함께 성장한 업소들의 실제 성과를 확인하세요.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-2xl border border-violet-500/20 bg-violet-500/5 p-8 text-center">
          ...
          <p className="mb-6 text-sm text-neutral-400">
            지금 일산룸포털을 도입하고 데이터 기반으로 업소를 성장시키세요.
          </p>
          <Link
            href="/for-business"
