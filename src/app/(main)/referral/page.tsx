...
export const metadata: Metadata = {
  title: "추천 프로그램 - NEON 나이트라이프",
  description:
    "NEON 추천 프로그램으로 친구를 초대하고 보상을 받으세요. 추천할수록 더 많은 혜택이 쌓입니다.",
};
...
const steps = [
  ...
  },
  {
    ...
    title: "친구 가입 완료",
    description:
      "공유한 링크를 통해 친구가 NEON에 회원가입을 완료하면 추천이 인정됩니다.",
    icon: "👤",
  },
  {
    step: 3,
...
const rewards = [
  ...
  },
  {
    tier: "골드",
    range: "15~29명 추천",
    reward: "추천 1건당 1,200 NEON 포인트 + 프리미엄 1주 무료",
  ...
  },
  {
    tier: "다이아몬드",
    range: "30명 이상 추천",
    reward: "추천 1건당 2,000 NEON 포인트 + 프리미엄 1개월 무료",
      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-xl text-lg text-neutral-400">
            추천 링크를 공유하면 당신과 친구 모두에게 NEON 포인트가 지급됩니다.
