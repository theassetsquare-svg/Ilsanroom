...
export const metadata: Metadata = {
  title: "이용약관 - NEON 나이트라이프",
  description: "NEON 나이트라이프 서비스 이용약관. 서비스 이용 조건, 회원 의무, 책임 제한 등을 안내합니다.",
};
...
const articles = [
  {
    ...
    title: "목적",
    content:
      '이 약관은 NEON(이하 "회사")이 제공하는 나이트라이프 정보 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.',
  },
  {
    number: "제2조",
    title: "정의",
