...
export const metadata: Metadata = {
  ...
  description: '15가지 한정식 코스에 국악 라이브까지. 일산명월관 신실장이 직접 안내하는 비즈니스 접대·기념일 맞춤 공간.',
...
export default function YojeongPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 space-y-12">
      <div>
        ...
        <div className="rounded-2xl border border-neon-border/50 bg-neon-surface/30 p-6">
          <p className="text-base leading-relaxed text-neon-text-muted">
            ...
            프라이빗한 독립 공간에서 정갈한 서비스를 받으며, 가야금·해금·대금 등 고유한 악기의 선율과 함께 식사를 즐기는 것이
            이 업종의 핵심입니다. 비즈니스 접대, VIP 미팅, 돌잔치, 환갑·칠순 잔치, 상견례 등
            격식이 필요한 자리에 최적입니다.
            일산명월관요정은 고양시 일산동구 장항로 895-1에 위치한 일산 대표 한정식 공간으로,
            총 30개 프라이빗 공간과 정찰제를 운영하며 신실장이 전반을 총괄합니다.
            역사 깊은 형태로 운영되는 곳은 전국에 많지 않아 희소성이 높습니다.
      ...
      <CategoryVSBattle venueA="일산명월관요정" venueB="청담클럽 아르쥬" topic="접대 장소 대결 — 전통 vs 모던" />
