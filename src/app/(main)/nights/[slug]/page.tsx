...
const defaultFaqs = (name: string) => [
  { question: `${name}의 위치와 교통편은?`, answer: `정확한 주소와 가까운 역 정보는 기본정보 탭에서 확인하세요. 지도 탭에서 카카오맵 길찾기도 가능합니다.` },
  { question: `영업시간이 궁금해요`, answer: `영업시간은 기본정보 탭에서 확인하세요. 방문 전 전화로 확인하시는 것을 권장합니다.` },
  { question: `주차가 가능한가요?`, answer: `주차 가능 여부는 기본정보 탭에서 확인할 수 있습니다. 대부분 인근 공영주차장 이용이 가능합니다.` },
  { question: `드레스코드가 있나요?`, answer: `업소마다 드레스코드가 다릅니다. 기본정보 탭에서 확인하거나 방문 전 전화 문의를 권장합니다.` },
  { question: `소셜 댄스를 즐길 수 있나요?`, answer: `대부분의 댄스홀에서 소셜 댄스를 즐길 수 있습니다. 라이브 밴드와 DJ 음악에 맞춰 다양한 춤을 즐겨보세요.` },
  { question: `주요 연령대는?`, answer: `연령대 정보는 기본정보 탭에서 확인할 수 있습니다.` },
  { question: `가격대가 어떻게 되나요?`, answer: `가격표 탭에서 상세 가격을 확인하세요. 정확한 금액은 업소에 직접 문의하시기 바랍니다.` },
  { question: `${name}에 처음 방문하는데 팁이 있나요?`, answer: `처음이시라면 직원에게 안내를 요청하세요. 편안하게 즐기실 수 있도록 친절히 도와드립니다.` },
];
