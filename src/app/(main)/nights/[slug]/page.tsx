...
const defaultFaqs = (name: string) => [
  ...
  { question: `주차가 가능한가요?`, answer: `주차 가능 여부는 기본정보 탭에서 확인할 수 있습니다.` },
  { question: `드레스코드가 있나요?`, answer: `나이트클럽마다 드레스코드가 다릅니다. 기본정보 탭에서 확인하거나 방문 전 전화 문의를 권장합니다.` },
  ...
  { question: `가격대가?`, answer: `가격표 탭에서 확인할 수 있습니다. 정확한 가격은 업소에 직접 확인하세요.` },
