...
const defaultFaqs = (name: string) => [
  { question: `${name}의 위치는 어디인가요?`, answer: `이 업소의 정확한 위치는 기본정보 탭에서 확인할 수 있습니다.` },
  { question: `영업시간이 궁금해요`, answer: `영업시간은 기본정보 탭에서 확인하세요. 대부분의 클럽은 밤 10시 이후 영업합니다.` },
  { question: `${name}의 입장료는 얼마인가요?`, answer: `가격표 탭에서 입장료와 테이블 가격을 확인할 수 있습니다.` },
  { question: `드레스코드가 있나요?`, answer: `대부분의 클럽은 스마트 캐주얼 이상을 권장합니다.` },
  ...
  { question: `분위기는 어떤가요?`, answer: `이 곳의 분위기와 특징은 기본정보 탭에서 확인하세요.` },
];
