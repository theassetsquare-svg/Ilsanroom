...
const faqs = [
  {
    question: "연간 결제하면 할인이 있나요?",
    answer:
      "네, 연간 결제 시 2개월 무료 혜택이 적용됩니다. 베이직 연간 ₩990,000, 프로 연간 ₩2,990,000, 하이엔드 연간 ₩5,990,000입니다.",
  },
  {
    question: "환불은 어떻게 되나요?",
    answer:
      "결제일로부터 7일 이내 전액 환불됩니다. 7일 이후에는 잔여 기간에 대해 일할 계산 환불이 적용됩니다. 무료 체험 중 취소하면 비용이 발생하지 않습니다.",
  },
  {
    question: "플랜 변경이 자유로운가요?",
    answer:
      "네, 언제든지 상위 또는 하위 플랜으로 변경할 수 있습니다. 상위 플랜으로 변경 시 차액만 결제되고, 하위 플랜으로 변경 시 다음 결제일부터 적용됩니다.",
  },
  {
