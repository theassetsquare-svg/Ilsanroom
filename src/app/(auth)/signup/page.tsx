...
export const metadata: Metadata = {
  title: "회원가입 - NEON 나이트라이프",
  description: "NEON 나이트라이프에 가입하고 다양한 나이트라이프 정보를 만나보세요.",
};
  ...
  return (
    <div>
      ...
      <form className="space-y-4">
        <div>
          <label htmlFor="nickname" className="mb-1.5 block text-sm font-medium text-neutral-300">
            닉네임
          </label>
          <input
            id="nickname"
        ...
        <div>
          <label htmlFor="passwordConfirm" className="mb-1.5 block text-sm font-medium text-neutral-300">
            비밀번호 확인
          </label>
          <input
            id="passwordConfirm"
        ...
        <div>
          <label htmlFor="birthYear" className="mb-1.5 block text-sm font-medium text-neutral-300">
            출생연도
          </label>
          <select
            id="birthYear"
            className="w-full rounded-xl border border-neutral-700 bg-neutral-950 px-4 py-3 text-sm text-neutral-500 outline-none transition focus:border-violet-500"
          >
        ...
        <div className="space-y-2 pt-2">
          <label className="flex items-start gap-2 text-sm text-neutral-400">
            <input type="checkbox" className="mt-1 rounded border-neutral-600 bg-neutral-800" />
      ...
      <p className="mt-6 text-center text-sm text-neutral-400">
        이미 계정이 있으신가요?{" "}
        <a href="/login" className="font-medium text-violet-400 hover:underline">
          로그인
        </a>
      </p>
    </div>
