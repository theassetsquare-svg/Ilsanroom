...
const timeSlots = [
  ...
  { range: '22:00~00:00', label: '피크 타임', venues: ['강남클럽 레이스', '부산연산동물나이트'], tip: '전 업종 가장 붐비는 시간대. 테이블 사전 예약 권장.' },
  { range: '00:00~02:00', label: '절정', venues: ['강남클럽 사운드', '이태원클럽 유토피아'], tip: 'EDM DJ 메인 세트 시간. 분위기 절정.' },
