...
const timeSlots = [
  { range: '18:00~20:00', label: '저녁 코스', venues: ['일산명월관요정', '해운대고구려'], tip: '한정식 문화 공간과 프라이빗 모임 공간이 오픈하는 시간. 접대와 저녁 모임에 최적.' },
  { range: '20:00~22:00', label: '본격 개장', venues: ['수원찬스돔나이트', '청담H2O나이트'], tip: '댄스홀이 본격 영업 시작. 일찍 가면 좋은 자리 확보 가능.' },
  { range: '22:00~00:00', label: '피크 타임', venues: ['강남청담클럽 레이스', '부산연산동물나이트'], tip: '전 업종 가장 붐비는 시간대. 테이블 사전 예약 권장.' },
  { range: '00:00~02:00', label: '절정', venues: ['강남청담클럽 사운드', '이태원클럽 유토피아'], tip: 'EDM DJ 메인 세트 시간. 분위기 절정.' },
  { range: '02:00~04:00', label: '심야', venues: ['홍대클럽 버뮤다', '강남호빠 로얄'], tip: '열정적인 파티피플의 시간. 호스트바도 이 시간대 인기.' },
];
