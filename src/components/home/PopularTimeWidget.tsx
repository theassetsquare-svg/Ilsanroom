...
const timeSlots = [
  ...
  { range: '20:00~22:00', label: '나이트 오픈', venues: ['수원찬스돔나이트', '청담H2O나이트', '인천아라비안나이트'], tip: '나이트클럽이 본격 영업 시작. 일찍 가면 좋은 자리 확보 가능.' },
  { range: '22:00~00:00', label: '피크 타임', venues: ['강남클럽레이스', '클럽NB2', '부산연산동물나이트'], tip: '클럽과 나이트 모두 가장 붐비는 시간대. 테이블 사전 예약 권장.' },
