  ...
  return (
    <div className="rounded-2xl border border-neon-green/30 bg-neon-surface p-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <a href="https://theassetsquare.com/" className="flex items-center justify-center gap-2 rounded-xl bg-neon-green/20 py-3 text-sm font-bold text-neon-green transition hover:bg-neon-green/30" style={{minHeight:'44px'}}>
          카카오T 대리 1577-4080
        </a>
        <a href="https://theassetsquare.com/" className="flex items-center justify-center gap-2 rounded-xl bg-neon-accent/20 py-3 text-sm font-bold text-neon-accent transition hover:bg-neon-accent/30" style={{minHeight:'44px'}}>
          로지 대리 1588-5765
        </a>
      </div>
    </div>
