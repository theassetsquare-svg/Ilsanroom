...
const TYPES: Record<string, { title: string; desc: string; venues: string[] }> = {
  ESTJ: { title: '파티 총괄 매니저', desc: '체계적으로 계획을 세워 완벽한 밤을 만드는 타입. 친구들의 일정부터 장소까지 당신이 정합니다.', venues: ['강남청담클럽 레이스', '수원찬스돔나이트'] },
  ...
  ENFP: { title: '모험하는 파티피플', desc: '새로운 곳을 탐험하고 다양한 사람을 만나는 걸 좋아하는 당신!', venues: ['이태원클럽 유토피아', '압구정클럽 하입'] },
