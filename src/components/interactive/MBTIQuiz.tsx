...
const TYPES: Record<string, { title: string; desc: string; venues: string[] }> = {
  ESTJ: { title: '파티 총괄 매니저', desc: '체계적으로 계획을 세워 완벽한 밤을 만드는 타입. 친구들의 일정부터 장소까지 당신이 정합니다.', venues: ['강남클럽 레이스', '수원찬스돔나이트'] },
  ESTP: { title: '자유로운 클러버', desc: '즉흥적이고 에너지 넘치는 당신! EDM 비트에 몸을 맡기고 새벽까지 달리는 게 최고.', venues: ['강남클럽 사운드', '홍대클럽 버뮤다'] },
