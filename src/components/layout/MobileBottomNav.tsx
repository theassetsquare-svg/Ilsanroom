      ...
      {notifOpen && (
        <div ref={notifRef} className="absolute bottom-full left-2 right-2 mb-1 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-[100]">
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
            ...
            <button onClick={() => { markAllRead(); setNotifOpen(false); }} className="text-xs text-[#8B5CF6] font-medium inline-flex items-center px-2 -mx-2" style={{ minHeight: 44 }}>모두 읽음</button>
          </div>
          {newPosts.length === 0 ? (
