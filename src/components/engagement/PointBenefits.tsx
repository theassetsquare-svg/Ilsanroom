...
const BENEFITS = [
  {
    points: 100,
    icon: '⭐',
    title: '탐험가 — 업소 상세 전체 + 댓글 + 조각',
    desc: '업소 상세 페이지 전체 열람, 댓글 작성, 조각 모집 글쓰기가 해금된다',
    color: '#06B6D4',
  },
  {
    points: 300,
    icon: '🔥',
    title: '매니아 — 커뮤니티 글쓰기 + AI 추천',
    desc: '자유게시판·후기·꿀팁 글쓰기 해금. AI 맞춤 추천 사용 가능',
    color: '#F97316',
  },
  {
    points: 700,
    icon: '💎',
    title: 'VIP — AI 코스 설계 + 취향 분석',
    desc: 'AI가 풀코스 동선을 짜주고, 내 취향을 분석해준다',
    color: '#8B5CF6',
  },
  {
    points: 1500,
    icon: '👑',
    title: '레전드 — AI 전체 해금 + VIP 게시판',
    desc: '모든 AI 기능 사용. 레전드끼리만 보이는 VIP 전용 게시판 입장',
    color: '#EC4899',
  },
  {
    points: 3000,
    icon: '🔥',
    title: '마스터 — 무료입장권 추첨 + 명예의 전당',
    desc: '매월 제휴업소 무료입장권 추첨 응모. 랭킹 페이지에 닉네임 등재',
    color: '#EF4444',
  },
  {
    points: 5000,
    icon: '✨',
    title: '신화 — 프라이빗 파티 초대',
    desc: '분기별 놀쿨 프라이빗 파티 초대. 매 500P마다 럭키박스 지급',
    color: '#F59E0B',
  },
];
