    ...
    <div className="col-span-2 sm:col-span-3 lg:col-span-4">
      {!revealed ? (
        ...
        >
          ...
          <p className="text-sm font-bold text-white/90">에디터만 아는 비밀 장소</p>
          <p className="mt-1 text-xs text-white/60">탭해서 확인하기</p>
        </button>
      ) : (
        <div className="rounded-2xl bg-gradient-to-br from-violet-900 to-purple-800 p-6 text-center">
          <p className="text-xs text-violet-300 mb-2">비밀 장소 공개!</p>
