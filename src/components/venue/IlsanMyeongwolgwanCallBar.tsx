/* 일산명월관 전용 하단 고정 전화 바 (모바일 + PC 공통).
   ...
   - 인쇄 시 숨김.
   - 표시 문구는 정확히 "일산룸 총책임자 010 4117 5556" 한 줄. 번호는 굵게, 좁은 화면에서도
...
export default function IlsanMyeongwolgwanCallBar() {
  return (
    ...
    >
      <a
        href="tel:01041175556"
        aria-label="일산룸 총책임자에게 전화 걸기 010 4117 5556"
      ...
      >
        <span className="whitespace-nowrap" style={{ color: '#FFFFFF', fontSize: 'clamp(13px,4.2vw,17px)', fontWeight: 600 }}>
          일산룸 총책임자{' '}
          <strong style={{ color: '#FFD700', fontWeight: 900, letterSpacing: '0.02em' }}>010 4117 5556</strong>
        </span>
      </a>
    </div>
  );
