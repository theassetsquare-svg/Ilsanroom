      ...
      <div className="w-full max-w-md rounded-2xl border border-neon-border bg-neon-surface p-6 sm:p-8" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="rounded-xl border border-neon-border bg-neon-bg p-4 mb-6">
          ...
          <div className="mt-2 pt-2 border-t border-neon-border">
            <span className="text-xs text-neon-text-subtle">월 정기결제 · 토스페이먼츠 처리</span>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="py-4 text-center">
            ...
            <a target="_blank" rel="noopener noreferrer" href="/onboarding" className="inline-block rounded-xl bg-neon-primary px-6 py-3 text-sm font-semibold text-neon-text transition hover:bg-neon-primary-light" style={{ minHeight: 48 }}>
              무료로 시작하기
            </a>
          </div>
        ) : (
