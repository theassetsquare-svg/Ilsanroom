...
-- 자유 게시판 (free)
('free', '택시비가 술값보다 나온 사람 나만?? ㅋㅋ', '어젯밤 강남에서 집까지 택시비가 술값을 넘겨버렸음ㅋㅋㅋ 다음부턴 걸어가야하나 심각하게 고민중'),
...
('free', '월요일인데 벌써 금요일 계획 세우는중ㅋ', '이번주는 홍대 갈까 강남 갈까 부산 원정 갈까 고민하는게 일주일의 즐거움이다'),
...
('free', '나이트 갔다가 아는 사람 만남ㅋㅋ', '세상 좁다는 게 이런건가 회사 동료를 나이트에서 만남 둘 다 어색해서 모른척 했음ㅋㅋㅋ 세상 진짜 좁다'),
...
('free', '클럽 갔는데 DJ가 내 요청곡 틀어줌ㅋㅋ', '원래 안 해준다는데 계속 부탁하니까 틀어줬음 그 순간 홀 분위기 미쳤다 ㅋㅋ'),
...
('free', '나이트에서 찍은 셀카가 제일 잘나옴ㅋㅋ', '조명빨인건 아는데 그래도 인생샷 나옴 프사 바꿀까 고민된다'),
...
('reviews', '아르쥬 VIP 후기 돈값은 하는듯', '강남 프리미엄 가격이긴 한데 서비스가 확실히 다름 전담 매니저가 붙어서 케어해줌 접대용으로는 최고더라'),
('reviews', '대전 세븐나이트 웨이터가 진짜 프로임', '처음 가봤는데 웨이터분이 분위기 잡아주고 부킹도 자연스럽게 연결해줌 대전에 이런데가 있었나 싶음'),
('reviews', '인천 라운지 가봤는데 강남이랑 비교불가', '솔직히 인천이라 기대 안했는데 분위기 좋고 칵테일 맛있고 가격도 착함 오히려 강남보다 나을수도'),
('reviews', '거래처 모시고 요정 갔더니 계약 따냄ㅋㅋ', '농담아니고 실화임 분위기 좋고 음식 맛있고 거래처 사장님이 감동받으셔서 그자리에서 계약서 사인함 요정 무시하면 안된다'),
...
('reviews', '강남 레이스 첫방문 후기 솔직하게', '소문대로 사운드 좋고 사람 많음 근데 금요일은 너무 붐벼서 좀 힘들었음 토요일이 더 나을듯 웨이터는 친절했다'),
...
('reviews', '대구 나이트 다녀옴 분위기 ㄹㅇ', '대구 사람들 놀줄 안다는 말이 괜히 있는게 아님 분위기 미쳤고 사람들도 좋음 또 갈거다'),
('reviews', '일산 요정 접대로 갔는데 거래처가 감동함', '명월관 갔는데 음식도 술도 분위기도 다 좋았음 거래처 사장님이 "여기 어떻게 알았냐"면서 좋아하심'),

-- 팁 (tips)
('tips', '입구에서 돈 아끼는 법 3가지 진짜 됨', '1.일찍 가면 프리 입장 많음 2.SNS 팔로우하면 할인 3.단체로 가면 할인해주는 곳 많음 이거 진짜 됨'),
('tips', '부킹 잘 되는 자리 위치 공개함', '무대 기준으로 오른쪽 2번째~3번째 테이블이 부킹 가장 잘됨 웨이터 동선이랑 시야 확보가 다 되는 자리다'),
('tips', '클럽 처음 가는 사람 복장 꿀팁 남자편', '청바지+흰셔츠+깔끔한 운동화 이게 정답임 너무 꾸미면 오히려 튀고 너무 편하면 입장 거절당함 적당히가 베스트다'),
('tips', '호빠에서 대접 잘 받는 꿀팁 5가지', '1.첫방문이라 말하기 2.선수한테 관심표현 3.팁 적당히 주기 4.시간 여유롭게 5.친구랑 같이가기 이러면 대접이 달라진다'),
('tips', '강남에서 지갑 안 털리고 노는 법', '1.해피아워 노리기 2.테이블 말고 바카운터 3.양주 대신 하이볼 4.프리입장 시간대 5.택시 대신 지하철 막차 이러면 된다'),
...
('tips', '접대할 때 요정 예약하는 법', '최소 하루 전에 예약하고 인원수 정확하게 예산 미리 말하면 맞춰줌 처음이면 솔직하게 처음이라고 하는게 낫다'),
('tips', '나이트 부킹 매너 정리해봄', '1.거절당해도 기분나빠하지 않기 2.대화할때 존댓말 3.무리한 요구 안하기 4.한잔만 같이 하자 이정도만 하면 인기남 된다'),

-- Q&A (discussion)
('discussion', '호빠 혼자 가면 진짜 괜찮음??', '처음인데 친구가 못간대 혼자 가도 되는건지 분위기가 어색하진 않은지 가본 사람 알려줘'),
('discussion', '룸 갈때 양주 뭐 시켜야됨?', '진심 모르겠음 메뉴판에 양주가 너무 많은데 무난한거 추천해줘 처음이라 쪽팔림'),
...
('discussion', '나이트 끝나고 어디로 가면 좋을까?', '나이트 끝나고 새벽인데 한 군데 더 갈만한 곳 추천좀 강남 기준으로'),
