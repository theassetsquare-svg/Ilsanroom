...
('free', '월요일 아침에 어제 일이 떠올라서 식은땀남', '뭐 한건지 기억이 안나는데 카드값 문자 보고 잠이 확 깼다 이게 뭐임'),
...
('free', '오늘 양주 안 시키는 날 만들었음', '맥주만 마시고 가벼운 텐션으로 놀았는데 의외로 더 재밌었음 머리도 안 아프더라'),
...
('free', '이번주 금요일 비온대 나이트 갈까 말까', '비오면 사람 적을거같은데 그래도 가야하나 고민되네'),
...
('free', '술 안먹고 가도 충분히 재밌음', '운전때문에 음료수만 마셨는데 음악 듣고 분위기만 즐겨도 좋더라'),
...
('free', '여친이랑 같이 클럽 가는 사람 있음', '괜찮은건지 분위기 어색하지않은지 가본 사람 알려줘라 어땠는지 궁금하다'),
('free', '오늘 진짜 많이 마셨다 진짜 ㅋㅋㅋ', '내일 출근인데 양주 한병 까고 맥주 5잔 더 마심 미친듯'),
('free', '클럽에서 사진 잘찍는 친구 진짜 부러움', '나는 어둡게만 나오는데 그 친구는 인생샷 뽑음 카메라 셋팅이 다른가'),
('free', '강남 vs 부산 클럽 분위기 차이 알려줘', '이번 출장에 부산 가는데 강남이랑 비교해서 어떤지 궁금하다'),
...
('free', '인천에서 강남까지 택시비 너무 아까움', '미터기 보다가 진짜 손이 떨림 다음엔 새벽버스 알아봐야지'),
...
('free', '강남보다 인천 라운지가 의외로 낫네', '강남에서 쓰던 돈 절반도 안 쓰고 인천에서 더 잘 놀았음'),
('free', '룸에서 도우미 안 시키고 친구들끼리만 노는것도 재밌음', '편하게 떠들면서 술 마시는 분위기가 더 좋을때 있더라 케이스 바이 케이스'),
...
('free', '대전에서 서울까지 클럽 원정 가본 사람', '서울 클럽이 그렇게 좋다는데 KTX 타고 가기엔 너무 멀고 고민된다'),
('free', '결혼하고 클럽 끊은 사람 있음', '결혼 한 친구들은 다 끊었던데 정말 끊을 수 있는건가? 진심 궁금하다'),
...
('free', '강남 라운지에서 외국인 친구 사귐', '영어 못해서 손짓발짓으로 대화했는데 너무 재밌었음 인스타 친구추가까지 했다'),
('free', '룸에서 아는 사람 만나면 못본척 vs 인사', '회사 부장님이랑 마주쳤는데 어쩌지 그자리에서 어색하게 인사해버렸다'),
...
('free', '광주에서 서울 클럽 원정온 친구', '서울이 그렇게 좋냐고 물어봤더니 분위기가 다르대 광주랑 비교가 안된다더라'),
...
('free', '나이트 갔다가 헌팅포차 가본적', '이게 더 재밌을때 있음 음악 시끄럽지 않고 대화하기 좋더라'),
('free', '40대 솔로인데 클럽가면 만남 있음?', '진심으로 궁금함 또래도 있는 곳이 있는지'),
('free', '클럽에서 한국말 못하는 외국인이랑 노는것도 재밌음', '말 안통해도 분위기로 통함 인스타로 연락도 한다'),
('free', '강남 vs 홍대 부킹 매너 차이', '강남이 좀 더 정중한편이고 홍대가 자유로운 편 둘 다 매력있더라'),
('free', '룸 안가본지 너무 오래됨 트렌드 바뀜?', '5년만에 가려는데 분위기나 가격 많이 달라졌나'),
('free', '나이트가는 직장 동료가 의외로 많음', '평소 조용한 부장님이 단골이래서 충격받았네 사람은 겪어봐야 안다'),
...
INSERT INTO seed_post_pool (category, title, content) VALUES
-- 강남
('reviews', '강남 옥타곤 진짜 강추 분위기 미침', '주말 11시쯤 갔는데 사람 진짜 많고 사운드 미쳤음 EDM 좋아하면 무조건 가야함 지갑은 좀 각오해야하는 편'),
...
('reviews', '클럽 피스타 솔직히 기대 이하였음', '들어가니까 사람도 적고 음악도 별로였음 평일이라 그런가 다음에 주말에 다시 가봐야지'),
('reviews', '강남 더라이브 프리미엄 가격값 한다', '고급스러운 분위기에 음향도 좋고 매너있는 손님들 많음 비즈니스 미팅에도 적합'),
('reviews', '아도니스 처음 가봤는데 분위기 압도적', '입장하자마자 분위기에 압도됨 음악 큐레이션 좋고 라운지 영역도 잘되어있더라'),
...
('reviews', '홍대 NB 갔는데 분위기 자유로움', '강남이랑은 완전 다른 분위기 자유롭고 편안함 20대 많고 가격도 합리적이더라'),
('reviews', '홍대 노이즈베이직 추천함 분위기굿', '음악도 좋고 사람들도 친절하고 부담도 강남보단 덜함 홍대 클럽 입문용으로 딱이다'),
('reviews', '홍대 사운드 첫방문 인정', '소문대로 사운드 진짜 좋음 EDM 좋아하면 강추 평일에도 사람 꽤 있음'),
('reviews', '홍대 오우라 분위기 트렌디함', '20대 초반이 많고 분위기 활기참 처음 클럽 가는 친구한테 추천하기 좋더라'),
('reviews', '홍대 모디 다녀옴 만족스러움', '입장 부담 적고 술값도 합리적임 친구들이랑 편하게 놀기 좋은 곳이더라'),
-- 이태원
('reviews', '이태원 케이크샵 외국인 많고 분위기 다름', '서울 다른 클럽이랑 분위기가 완전 다름 외국인 비율 50% 영어로 대화 많더라'),
('reviews', '이태원 스카이라운지 야경 미쳤다', '한강 야경 보면서 칵테일 마시는 분위기 진심 미침 데이트로 강추'),
('reviews', '이태원 라운지 갔는데 외국인 친구 많이 사김', '여러 나라 사람들 한자리에 모여서 대화하는 분위기 너무 좋았다'),
-- 부산
...
('reviews', '부산 크리스탈 분위기 인정', '해운대 끝쪽에 있는데 분위기 좋고 사람도 친절함 부산 가면 꼭 가는 곳이다'),
('reviews', '부산 클럽 더라스트 후기 강추', '서면쪽인데 분위기 미침 부산 사람들 진짜 잘놀더라 강남이랑 비교불가'),
('reviews', '부산 라운지 더쉬 분위기 정말 좋음', '광안리 야경 보면서 칵테일 마시는데 인생 명장면 데이트로 추천한다'),
-- 수원
('reviews', '수원 찬스돔 부킹 진짜 잘됨', '강남 안가도 됨 수원에서 충분함 실장님 친절하고 사람도 많음'),
('reviews', '수원 라온 분위기 인정', '인계동 라온 갔는데 생각보다 사람 많고 분위기 좋음 돈 아깝지 않더라'),
('reviews', '수원 더쇼 후기 분위기 미침', '인계동 자주 가는데 더쇼가 제일 좋음 사람도 많고 음악도 좋더라'),
-- 대전
...
('reviews', '일산 라운지바 더쉘 분위기 좋음', '백석동 더쉘 갔는데 칵테일 맛있고 분위기 차분함 데이트하기 좋다'),
-- 대구
('reviews', '대구 챔피언 분위기 미쳤음', '대구 왔으면 무조건 가야함 사운드 좋고 사람도 많고 분위기 미쳤더라'),
('reviews', '대구 더그레이 후기 인정', '동성로 더그레이 갔는데 트렌디한 분위기 20대 많고 음악도 좋더라'),
('reviews', '대구 클럽 비트 분위기 좋더라', '대구 사람들 잘노는거 인정함 비트 음악 좋고 사운드도 좋음'),
-- 광주/울산/인천
('reviews', '광주 챔피언 분위기 정말 좋음', '광주 첫방문이었는데 사람들 친절하고 분위기 활기참 또 갈거다'),
('reviews', '광주 더라운지 가본 후기', '상무지구 라운지 갔는데 분위기 차분하고 칵테일 맛있음 데이트 추천'),
('reviews', '울산 챔피언 돈값 제대로 함', '울산은 챔피언이 진리다 가격도 착하고 분위기도 좋음'),
('reviews', '울산 라운지 더쉘 분위기 좋더라', '삼산동에 있는데 칵테일 맛있고 분위기도 차분함 어른들이 많음'),
('reviews', '인천 구월동 클럽 후기 솔직버전', '강남이랑 비교하면 가격 반값에 분위기 비슷함 인천 사람들 잘놀더라'),
...
('reviews', '강남 룸 더원 만족도 굿', '강남치고 가격이 합리적임 분위기도 좋고 매니저도 친절하더라'),
('reviews', '강남 요정 더화 분위기 정말 좋음', '한국 전통 분위기에 음식도 맛있음 외국 거래처 모시고 가기 딱 좋음'),
('reviews', '강남 룸 더팰리스 추천', '럭셔리한 분위기에 양주 종류 많고 도우미 매너있음 비싸지만 값한다'),
...
('reviews', '강남 호빠 분위기 솔직 후기', '여자분들끼리 가서 신나게 놀았음 매니저 친절하고 선수들 매너있고 추천한다'),
('reviews', '홍대 호빠 가본 후기 분위기굿', '홍대답게 자유로운 분위기 강남보단 가격 착하고 분위기 편하더라'),
('reviews', '부산 호빠 후기 분위기 좋음', '해운대 호빠 갔는데 부산답게 사람들 친절하고 분위기 활기차더라'),
-- 라운지
('reviews', '강남 라운지 무드 분위기 미침', '청담동 라운지인데 분위기 진짜 차분하고 칵테일도 맛있음 어른들 데이트로 강추'),
('reviews', '청담 라운지 더루프 야경 미침', '한강 야경 보면서 칵테일 마시는 분위기 진심 인생샷 명소다'),
('reviews', '강남 라운지 더가든 분위기 좋더라', '식물 인테리어로 차분한 분위기 데이트하기 좋고 사진 잘나옴'),
('reviews', '이태원 라운지 더쉘 외국인 친구 사김', '외국인 비율 높아서 영어 연습도 되고 분위기 좋더라'),
...
('reviews', '청담동 룸 가격 솔직히 비싸지만', '인당 꽤 들었는데 그만큼 서비스 좋음 거래처용으로 추천'),
('reviews', '부산 룸 후기 강남보다 알참', '부산 룸 가봤는데 강남보다 가격 착하고 서비스도 좋음 출장갈때 추천'),
...
('reviews', '대전 룸 후기 생각보다 괜찮더라', '대전 출장중에 갔는데 가격 착하고 서비스 괜찮음 거래처 만족'),
('reviews', '광주 룸 분위기 정말 좋더라', '광주 출장 갔다가 거래처랑 갔는데 분위기 좋고 음식 맛있음'),
('reviews', '대구 룸 후기 분위기 인정', '동성로 룸 갔는데 분위기 어른스럽고 서비스 좋음 거래처도 만족했다'),
('reviews', '울산 룸 후기 진짜 실속 좋음', '울산 출장 갈때마다 가는 곳 가격 착하고 분위기 좋음'),
('reviews', '부산 라운지 광안리 야경 미침', '광안리 라운지 진짜 야경 미쳤음 데이트로 강추 칵테일도 맛있음'),
('reviews', '대구 라운지 분위기 좋더라', '동성로 라운지 갔는데 어른들 많고 분위기 차분함 데이트로 좋음'),
('reviews', '강남 룸 양주 추천 메뉴 후기', '발렌타인 17 시켰는데 이거면 진짜 충분함 30년산까진 안가도 됨'),
('reviews', '강남 룸 음식 메뉴 진짜 맛있음', '안주 메뉴 다양하고 음식 퀄리티 진짜 좋음 만족함'),
('reviews', '룸 노래방 시스템 진짜 좋더라', '최신곡 다 있고 사운드도 좋음 친구들이랑 노래 부르기 너무 좋았음'),
('reviews', '강남 클럽 입장 후 분위기 후기', '입장하자마자 분위기에 압도당함 음악 좋고 사람 많고 만족했다'),
...
INSERT INTO seed_post_pool (category, title, content) VALUES
('tips', '클럽 입장 거절당하지 않는 법', '복장 단정하게 운동화는 깔끔한걸로 모자나 후드는 벗고 입장 신분증은 필수다'),
('tips', '나이트 부킹 매너 5가지', '1.거절당해도 기분좋게 2.대화시 존댓말 3.무리한 요구 금지 4.한잔 같이 5.연락처 강요 노노 이것만 지켜도 중간은 간다'),
('tips', '룸 처음 가는 사람 양주 주문 가이드', '발렌타인 17이 제일 무난한 베스트 윈저 17도 좋음 처음이면 시바스리갈 12부터 시작해도 된다'),
('tips', '강남 클럽 할인받고 들어가는 법', '인스타 팔로우하면 할인 많고 일찍 가면 프리입장 단체할인도 잘 챙겨야 한다'),
('tips', '클럽에서 사진 잘 찍는 꿀팁', '플래시 끄고 무드등 활용 친구한테 옆에서 잡으라고 하면 인생샷 나온다'),
('tips', '나이트 첫방문자 옷차림 추천', '남자: 셔츠+청바지+운동화 / 여자: 원피스+굽 너무높지않은 신발이 베스트다'),
('tips', '강남 택시 빨리 잡는 방법 공유', '강남역 말고 한블록 떨어진 곳에서 잡으면 됨 카카오T 호출도 콜비 더 줘서 부르면 된다'),
('tips', '클럽 안전하게 노는 법', '음료 자리비울때 다 마시고 가기 친구랑 같이 화장실 가기 위치공유 켜기 이게 진짜 기본이다'),
('tips', '룸에서 거래처 접대 잘하는 꿀팁', '미리 예약하고 인원수 정확히 매니저한테 이름 말씀드리면 케어 잘해준다'),
('tips', '나이트 단골 되는 법 알려줌', '같은 실장님 찾아가기 자주 가기 매너있게 행동 팁 적당히 주기 이거면 된다'),
('tips', '클럽 음악 좋은 시간대는?', '11시-2시가 피크타임 DJ 라인업 좋고 사람 많아서 분위기 미침'),
('tips', '호빠 가는 여자분들 알아둘 매너', '예약 미리 선수 지명할거면 미리 말씀 결제는 카드 가능 매너는 기본이다'),
('tips', '클럽 부킹 받기 좋은 자리', '무대 정면이나 우측 2번째 줄이 부킹 잘됨 입구 가까운 자리는 부킹 적음'),
('tips', '룸 가격 미리 확인하는 법', '예약할때 인당 가격 정확히 물어보고 양주 종류별 가격도 미리 확인해야 낭패 없다'),
('tips', '클럽 처음 가는 친구 데려갈때', '미리 분위기 알려주고 옷차림 가이드 해주고 부담스럽지 않게 케어하면 된다'),
('tips', '강남 클럽 평일이 더 좋은 이유', '평일은 사람 적당하고 부킹 잘됨 단골들 많아서 분위기도 좋음'),
('tips', '나이트 가기 전 식사 추천', '기름진 음식 피하고 가벼운거 추천 라면 김밥 정도가 좋더라'),
('tips', '클럽 음악 못따라가도 괜찮음', '리듬감 없어도 분위기만 즐기면 됨 어색하면 술 한잔 더 하면서 친구랑 대화'),
('tips', '룸 도우미 매너있게 부르는 법', '존댓말 사용 무리한 요구 안하기 팁 적당히 주기 매너있게 대화하면 된다'),
('tips', '클럽 경험치 쌓는 법', '여러 클럽 가보고 자기 스타일 찾기 강남 홍대 이태원 다 가보면 된다'),
('tips', '나이트 후 안전하게 귀가하는 법', '대리 부르거나 택시 미리 호출 위치공유 켜고 친구랑 동행하는게 답이다'),
('tips', '클럽 분위기 좋은 요일 추천', '금요일 토요일이 베스트 일요일은 분위기 좀 다르다'),
('tips', '룸 알뜰하게 노는 꿀팁', '평일에 가기 매니저 친한 사람한테 부탁 단체할인 챙기면 끝이다'),
('tips', '나이트 시간 효율적으로 노는 법', '11시쯤 가서 새벽 3시까지가 골든타임 너무 일찍이나 늦게 가면 분위기 다름'),
('tips', '클럽 옷 보관 팁', '소지품은 락커 사용 귀중품은 바카운터 보관 부탁도 된다'),
('tips', '강남 vs 홍대 클럽 차이점 정리', '강남: 비싸고 럭셔리 / 홍대: 자유롭고 부담 덜함 / 본인 스타일 찾으면 된다'),
('tips', '룸 처음 가는 사람 옷차림', '셔츠+슬랙스 정도가 베스트 너무 캐주얼은 분위기 안맞는다'),
('tips', '나이트 부킹 잘되는 시간대', '11시-1시가 피크 너무 늦게 가면 사람들 정신없음 일찍이 좋음'),
('tips', '클럽 처음가는 사람 마음가짐', '부담갖지 말고 분위기 즐기기 부킹 안와도 친구들이랑 즐기면 된다'),
('tips', '룸 초이스 잘하는 꿀팁', '도우미 분위기랑 본인 취향 맞춰서 매니저한테 미리 분위기 말해두면 된다'),
('tips', '클럽 화장실 사용 팁', '여자화장실 줄 길때 1층보다 위층 사용 남자화장실은 시간차 활용'),
('tips', '강남 클럽 부담 적은 시간', '프리입장 시간 노리기 인스타 이벤트 활용 평일에 가면 된다'),
('tips', '룸 양주 종류별 특징', '발렌타인: 부드러움 / 윈저: 진함 / 잭다니엘: 향 좋음 / 본인 취향대로 고르면 된다'),
('tips', '클럽 술 적당히 마시는 법', '물 자주 마시고 칵테일이랑 양주 섞지 말기 안주 꼭 챙겨먹어야 안 망한다'),
('tips', '나이트 안전한 부킹 매너', '연락처 받고 다음날 연락 안받아도 매너있게 처음부터 무리한 요구는 금물이다'),
('tips', '룸 매니저랑 친해지는 법', '자주 가기 팁 적당히 주기 매너있게 행동 단골되면 케어 진짜 잘해줌'),
('tips', '클럽 친구랑 시너지 잘 내는 법', '한명은 텐션 한명은 분위기 잡고 역할 분담하면 부킹 잘됨'),
('tips', '강남 클럽 주차 꿀팁', '강남역 공영주차장 활용 주말은 일찍 가야 자리 있음 발렛도 가능하다'),
('tips', '룸 음식 메뉴 추천 베스트', '치즈플레이트 + 과일 조합이 진리 안주 든든하게 먹어야 안 취한다'),
('tips', '나이트 dj 신청곡 받는 법', '돈 주는것보다 매너있게 부탁하는게 효과적 테이블에서 매니저 통해'),
('tips', '클럽 텐션 올리는 꿀팁', '술 적당히 마시고 음악에 몸 맡기기 친구들이랑 주거니받거니 하면 분위기 산다'),
('tips', '룸 도우미 분위기 좋게 만드는 법', '매너있게 대화 술 같이 마시기 노래 같이 부르기 강요만 안 하면 된다'),
('tips', '강남 클럽 vip 테이블 잡는 법', '4명 기준 양주 1병 포함 구성이 보통 자세한 건 매니저한테 미리 물어봐야'),
('tips', '나이트 처음 가는 30대 가이드', '20대 클럽이랑 분위기 다름 30대 많은 곳 골라서 가야 편하다'),
('tips', '클럽 4-50대 추천 장소', '강남 라운지 청담동 어른들 많은 클럽 분위기 차분하고 매너있다'),
('tips', '룸 4시간 풀코스 구성', '4명기준 양주 + 도우미 + 안주 풀세트 견적은 매장마다 다름'),
('tips', '나이트 단체로 가는 꿀팁', '미리 예약 인원수 정확히 테이블 미리 잡기 단체할인 활용하면 된다'),
('tips', '클럽 초보 부킹 매너 5가지', '1.거절당해도 웃기 2.연락처 강요 노노 3.존댓말 4.무리한 신체접촉 노노 5.매너있게 이게 전부다'),
('tips', '룸 양주 1병 4명이 적당량', '4명이서 양주 1병이 딱 적당함 더 많이 시키면 다음날 죽음'),
('tips', '나이트 가기 전 컨디션 만드는 법', '낮잠 자두고 가벼운 식사 물 많이 마시기 컨디션 좋게 가야 버틴다'),
('tips', '클럽 음악 좋아하는 사람 추천', 'EDM은 옥타곤 힙합은 사운드홀릭 트렌디는 메이드 취향따라 가면 된다'),
('tips', '강남 룸 예약 잘하는 법', '주말은 1주일 전부터 예약 평일은 당일도 가능 인원수 정확히'),
('tips', '나이트 솔로로 가도 괜찮은 곳', '라운지 추천 친구 사귀기 좋고 부담없이 갈수있음 청담동 라운지가 베스트다'),
('tips', '클럽 음료 안전하게 마시는 법', '잔 자리비울때 마시고 새거 시키기 음료 받을때 직접 받는게 안전하다'),
('tips', '룸 분위기 잡는 매니저 찾는 법', '자주 가서 친해지기 인스타로 미리 연락 친구 소개로 가는것도 방법이다'),
('tips', '나이트 부킹 후 데이트 매너', '강압적이지 않게 자연스럽게 다음 만남 미리 약속 잡지말기'),
('tips', '클럽 미리 알아보고 가는 꿀팁', '인스타 검색해서 분위기 확인 친구한테 후기 듣고 발품 비교하면 실패 없다'),
('tips', '룸 단골이면 받는 혜택 정리', '좋은자리 도우미 케어 가격 할인 매니저 추천 받기 진짜 다름'),
('tips', '나이트 가서 만난 사람이랑 다음 약속', '클럽에서 잡지말고 카톡으로 다음에 약속 잡기 강압적이지 않게'),
('tips', '강남 클럽 신분증 검사 팁', '주민증 면허증 여권 다 가능 외국인은 여권 필수 미리 챙겨야 한다'),
('tips', '룸 처음가서 안 망하는 꿀팁', '메뉴판 미리 보고 가격 확인 매니저한테 솔직히 처음이라고 말하면 된다'),
...
('discussion', '강남 클럽 들어갈 때 보통 얼마?', '평일 주말 차이 있는지 평균 가격 알려줘'),
...
('discussion', '강남 클럽 vip 테이블 얼마부터?', '4명 기준 vip 테이블 대략 얼마인지 알고 싶음 양주 포함'),
('discussion', '룸 가서 노래 안부르면 어색?', '노래 못부르는데 분위기상 부르지 않으면 이상한지'),
('discussion', '클럽 처음인데 친구가 자꾸 부킹하라고함', '나는 그냥 분위기 즐기고 싶은데 친구가 자꾸 부킹 강요해서 부담됨 이럴땐 어떻게 함?'),
...
('discussion', '룸 4시간 풀코스 대략 얼마?', '4명 기준 풀코스로 놀면 인당 얼마 잡아야'),
('discussion', '강남 클럽 일찍 가면 입장 무료?', '오픈시간 맞춰가면 무료라고 하던데 진짜인지'),
('discussion', '나이트 부킹 후 카톡 답장 매너', '연락처 주고받았는데 다음날 카톡 안오면 그냥 끝?'),
('discussion', '룸 양주 종류 너무 많아서 고민', '발렌타인 윈저 잭다니엘 차이가 뭔지 아는 사람? 추천 부탁'),
('discussion', '클럽에서 핸드폰 충전 가능?', '배터리 다되면 답없는데 충전소 있는 클럽 있나'),
('discussion', '강남 룸 추천 부탁 거래처 모시는중', '거래처 사장님 모시고 갈건데 분위기 좋고 서비스 좋은곳 어디 없나?'),
...
('discussion', '룸 처음 가는 4-50대 추천 장소', '거래처 모시고 갈건데 4-50대 분위기 좋은곳 아시는 분?'),
...
('party', '금요일 홍대 사운드홀릭 같이 갈 사람', '20대 후반 남자 2명 더 구함 들어가는 돈은 같이 분담'),
...
('party', '청담 라운지 데이트 조각', '커플끼리 4커플 모임 청담 라운지 분위기잡고 놀실 분?'),
...
('party', '대전 둔산동 클럽 조각', '대전 둔산동 토요일 한 명 빠져서 급구 30대 위주'),
('party', '강남 청담 룸 조각 구함', '청담 분위기 좋은 룸에서 같이 한잔 4명 모집'),
('party', '수원 인계동 클럽 같이 갈사람', '수원 인계동 더쇼 4명 모집 토요일 10시'),
('party', '부산 광안리 라운지 조각', '광안리 야경 보면서 한잔 두 명 더 구함 매너있는분'),
('party', '강남 호빠 여자분들 조각', '여자친구들끼리 호빠 첫방문 4명 모집 분위기 잘잡으실분'),
('party', '대구 동성로 클럽 조각', '대구 동성로 챔피언 토요일 4명 채우면 출발'),
('party', '강남 라운지 어른들 조각', '40대 분위기 차분한 라운지 4명 더 구합니다 매너있는분'),
('party', '홍대 사운드 평일 조각', '평일 사운드 2명만 더 EDM 좋아하시는분 우대'),
('party', '부산 서면 클럽 조각', '서면 더라스트 토요일 3명만 더 구함 부산사람'),
('party', '강남 더가든 라운지 데이트 조각', '커플 4커플 라운지 데이트 분위기 좋은 분들이면 된다'),
('party', '청담 룸 풀코스 조각', '청담 풀코스 4명 모집 비용 분담 매너있는분'),
('party', '이태원 라운지 외국인 모임', '외국인 친구들이랑 이태원 라운지 가실분? 영어되면 더 좋다'),
('party', '일산 명월관 접대 조각', '거래처 모시고 명월관 4명 매너있는 분만'),
('party', '강남 옥타곤 평일 조각 4명', '평일이라 부담없이 3명 더 모심 30대 위주'),
('party', '홍대 모디 주말 조각 구해요', '홍대 모디 요즘 괜찮다해서 4명 모집 토요일'),
('party', '강남 클럽 4명 vip 조각', '4명 비용 분담 vip 테이블 30대 후반 환영'),
('party', '부산 크리스탈 해운대 조각', '해운대 크리스탈 한 팀 더 구함 부산 거주자 우대'),
('party', '대전 세븐나이트 평일 조각', '평일 분위기 좋을때 2명 더 구함 대전 사람'),
('party', '강남 룸 친구들이랑 조각', '친구들이랑 8명 단체로 갈건데 절반만 더 채우면 됨'),
('party', '청담 라운지 어른들 조각', '40대 분위기 좋은 청담 라운지 4명 더'),
('party', '강남 클럽 토요일 단체 조각', '8명 단체 토요일 조각구함 4명 모집중'),
('party', '인천 송도 라운지 조각', '송도 야경 라운지 4명 자리 남음 인천 거주자'),
...
('party', '강남 라운지 30대 모임', '30대 직장인 모임 라운지 3명 남았음'),
...
('party', '강남 클럽 단체 조각 8명', '강남 클럽 8명 단체 마지막 4명 모집 토요일'),
...
('party', '울산 챔피언 단체 조각', '울산 챔피언 8명 단체 4자리 비었음'),
